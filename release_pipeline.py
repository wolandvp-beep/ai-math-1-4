...
V503 goal: remove repetitive manual GitHub Pages deployment while keeping the
...
Run from the project root that contains `backend/` and `frontend/`:
    ...
    python -B backend/release_pipeline.py --offset 0 --limit 100
...
DEFAULT_RELEASE = 'v503_02_automation_pipeline'
DEFAULT_AUDIT_KEY = 'v503-02-live-audit'
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description='Math AI 1-4 V503 release/audit pipeline helper')
