...
V504 goal: remove repetitive manual GitHub Pages deployment while keeping the
...
Run from the project root that contains `backend/` and `frontend/`:
    ...
    python -B backend/release_pipeline.py --offset 100 --limit 100
...
DEFAULT_RELEASE = 'v504_02_automation_pipeline'
DEFAULT_AUDIT_KEY = 'v504-02-live-audit'
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description='Math AI 1-4 V504.02 release/audit pipeline helper')
