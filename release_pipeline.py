...
DEFAULT_RELEASE = 'v504_01_automation_pipeline'
DEFAULT_AUDIT_KEY = 'v504-01-live-audit'
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description='Math AI 1-4 V504.01 release/audit pipeline helper')
