...
DEFAULT_RELEASE = 'v504_automation_pipeline'
DEFAULT_AUDIT_KEY = 'v504-live-audit'
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description='Math AI 1-4 V504 release/audit pipeline helper')
