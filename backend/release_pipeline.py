...
V506.07 goal: remove repetitive manual GitHub Pages deployment while keeping the
...
DEFAULT_RELEASE = 'v506_07_robust_json_snapshot'
DEFAULT_AUDIT_KEY = 'v506-07-live-audit'
