...
V506.06 goal: remove repetitive manual GitHub Pages deployment while keeping the
...
DEFAULT_RELEASE = 'v506_06_self_contained_json_report'
DEFAULT_AUDIT_KEY = 'v506-06-live-audit'
