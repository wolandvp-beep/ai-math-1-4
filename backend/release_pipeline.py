...
V506.08 goal: remove repetitive manual GitHub Pages deployment while keeping the
...
DEFAULT_RELEASE = 'v506_08_valya_examples_proof'
DEFAULT_AUDIT_KEY = 'v506-08-live-audit'
