...
def _ui_render_audit_url(request: Request | None, key: str | None = None) -> str:
    ...
    query = urlencode([
        ...
        ('limit', '100'),
        ('autoStart', '1'),
        ('cacheBust', 'v530-03-v50103-excel-2101-2200'),
    ])
...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v530-03-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v530-03-v50103-excel-2101-2200-v1'
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v530-03-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
