...
def _ui_render_audit_url(request: Request | None, key: str | None = None) -> str:
    ...
    query = urlencode([
        ...
        ('offset', '900'),
        ('limit', '100'),
        ('cacheBust', 'v518-01-v50103-excel-901-1000'),
    ])
...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v518-01-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v518-01-v50103-excel-901-1000-v1'
...
def _api_v51801_batch_901_1000_canonicalize_response(original_text: str, payload: dict[str, Any] | None) -> dict[str, Any] | None:
    """Route-level final visible guard for Excel rows 901-1000.
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v518-01-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
