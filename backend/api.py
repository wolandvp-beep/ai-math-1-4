...
def _ui_render_audit_url(request: Request | None, key: str | None = None) -> str:
    ...
    query = urlencode([
        ...
        ('offset', '500'),
        ('limit', '100'),
        ('cacheBust', 'v515-01-v50103-excel-601-700'),
    ])
...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v515-01-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v515-01-v50103-excel-601-700-v1'
...
def _api_v40305_nonnumeric_assignment_answer_only_payload(original_text: str, payload: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    out.update({
        ...
        'visibleResultContract': 'v515-01-v50103-excel-601-700',
        'v40305NonNumericAnswerOnly': True,
        'verifier': (prev_verifier + '; ' if prev_verifier else '') + 'v515-01-v50103-excel-601-700',
    })
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v515-01-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
