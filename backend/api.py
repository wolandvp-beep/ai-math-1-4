...
def _ui_render_audit_url(request: Request | None, key: str | None = None) -> str:
    ...
    query = urlencode([
        ...
        ('offset', '1700'),
        ('limit', '100'),
        ('cacheBust', 'v526-02-v50103-excel-1701-1800'),
    ])
...
def _next_live_audit_links(request: Request | None = None, key: str | None = None) -> dict:
    ...
    return {
        'nextAuditPlannedMapStep': 'V526.02 — V501.03 architecture / batch 1701–1800 route final guard',
...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v526-02-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v526-02-v50103-excel-1701-1800-v1'
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v526-02-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
