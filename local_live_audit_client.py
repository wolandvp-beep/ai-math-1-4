#!/usr/bin/env python3
"""Run the V311.07 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v311.07_live_g4_arithmetic_strict_api_visible_dom"
DEFAULT_KEY = "v311.07-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V311.07"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V311.07 production live audit and save proof results.")
