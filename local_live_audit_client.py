#!/usr/bin/env python3
"""Run the V299 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v299_live_g1_math_information_ui_render_evidence"
DEFAULT_KEY = "v299-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V299"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V299 production live audit and save proof results.")
