#!/usr/bin/env python3
"""Run the V298 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v298.02_live_g1_geometry_ui_render_compact_retry_and_frontend_fix"
DEFAULT_KEY = "v298.02-live-audit"
DEFAULT_SECTION = "g1_geometry"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V298"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V298 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v298_live_audit_result.json", help="Output JSON file")
