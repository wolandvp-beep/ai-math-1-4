#!/usr/bin/env python3
"""Run the V307.02 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v307.02_live_g3_text_problems_column_solutions"
DEFAULT_KEY = "v307.02-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V307.02"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V307.02 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v307_02_live_audit_result.json", help="Output JSON file")
