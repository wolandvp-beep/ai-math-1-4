#!/usr/bin/env python3
"""Run the V297.05 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v297.05_live_g1_text_problems_answer_phrase_alignment"
DEFAULT_KEY = "v297.05-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V297.05"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V297.05 production live audit and save proof results.")
