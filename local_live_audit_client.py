#!/usr/bin/env python3
"""Run the V296.13 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v296.14_live_g1_arithmetic_actions_ui_true_false_dom_alignment"
DEFAULT_KEY = "v296.14-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V296.13"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V296.13 production live audit and save proof results.")
