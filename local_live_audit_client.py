#!/usr/bin/env python3
"""Run the V308 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v308.01_live_g3_geometry_power_units"
DEFAULT_KEY = "v308.01-live-audit"
DEFAULT_SECTION = "g3_geometry"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V308"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V308 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v308.01_live_audit_result.json", help="Output JSON file")
