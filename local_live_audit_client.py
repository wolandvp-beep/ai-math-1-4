#!/usr/bin/env python3
"""Run the V311.08 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v311.08_live_g4_arithmetic_audit_replay_restore"
DEFAULT_KEY = "v311.08-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V311.08"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V311.08 production live audit and save proof results.")
