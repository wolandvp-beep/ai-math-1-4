#!/usr/bin/env python3
"""Run the V296.04 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v296.04_live_g1_arithmetic_actions_browser_audit"
DEFAULT_KEY = "v296.04-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V296.04"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V296.04 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v296_04_live_audit_result.json", help="Output JSON file")
