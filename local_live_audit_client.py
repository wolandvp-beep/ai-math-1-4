#!/usr/bin/env python3
"""Run the V317.1 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v317.1_live_tts_voice"
DEFAULT_KEY = "v317.1-live-audit"
DEFAULT_SECTION = "tts_voice"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V317.1"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V317.1 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v317.1_live_audit_result.json", help="Output JSON file")
