#!/usr/bin/env python3
"""Run the V296.11 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v296.11_live_g1_arithmetic_actions_single_step_no_number_ui"
DEFAULT_KEY = "v296.11-live-audit"
DEFAULT_SECTION = "g1_arithmetic_actions"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V296.11"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V296.11 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v296_11_live_audit_result.json", help="Output JSON file")
