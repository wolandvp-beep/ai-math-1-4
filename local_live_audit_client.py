#!/usr/bin/env python3
"""Run the V314.4 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v314.4_live_g4_math_information"
DEFAULT_KEY = "v314.4-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V314.4"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V314.4 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v314.4_live_audit_result.json", help="Output JSON file")
