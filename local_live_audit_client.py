#!/usr/bin/env python3
"""Run the V306 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v306.01_live_g3_arithmetic_actions_letter_expr_one_step_fix"
DEFAULT_KEY = "v306.01-live-audit"
DEFAULT_SECTION = "g3_arithmetic_actions"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V306"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V306 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v306_01_live_audit_result.json", help="Output JSON file")
