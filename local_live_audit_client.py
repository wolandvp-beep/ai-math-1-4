#!/usr/bin/env python3
"""Run the V299.01 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v299.01_live_g1_math_information_table_router_fix"
DEFAULT_KEY = "v299.01-live-audit"
DEFAULT_SECTION = "g1_math_information"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V299.01"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V299.01 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v299_live_audit_result.json", help="Output JSON file")
