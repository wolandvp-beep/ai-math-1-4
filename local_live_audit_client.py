#!/usr/bin/env python3
"""Run the V311.10 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v311.10_live_g4_arithmetic_expression_equation_render_fix"
DEFAULT_KEY = "v311.10-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V311.10"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V311.10 production live audit and save proof results.")
