#!/usr/bin/env python3
"""Run the V297.03 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v297.03_live_g1_text_problems_visible_result_alignment"
DEFAULT_KEY = "v297.03-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V297.03"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V297.03 production live audit and save proof results.")
