#!/usr/bin/env python3
"""Run the V305 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v305_live_g3_numbers_quantities"
DEFAULT_KEY = "v305-live-audit"
DEFAULT_SECTION = "g3_numbers_quantities"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V305"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V305 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v305_live_audit_result.json", help="Output JSON file")
