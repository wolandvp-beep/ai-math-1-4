#!/usr/bin/env python3
"""Run the V307 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v307_live_g3_text_problems"
DEFAULT_KEY = "v307-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V307"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V307 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v307_live_audit_result.json", help="Output JSON file")
