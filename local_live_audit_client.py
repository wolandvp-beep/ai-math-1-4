#!/usr/bin/env python3
"""Run the V302 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v302.01_live_g2_text_problems_expected_contract_fix"
DEFAULT_KEY = "v302.01-live-audit"
DEFAULT_SECTION = "g2_text_problems"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V302"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V302 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v302_live_audit_result.json", help="Output JSON file")
