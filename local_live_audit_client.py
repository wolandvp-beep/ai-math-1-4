#!/usr/bin/env python3
"""Run the V297 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v297.01_live_g1_text_problems_guard_evidence_answer_alignment"
DEFAULT_KEY = "v297-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V297"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V297 production live audit and save proof results.")
