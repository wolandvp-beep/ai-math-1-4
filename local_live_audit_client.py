#!/usr/bin/env python3
"""Run the V311.02 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v311.02_live_g4_arithmetic_columnar_flow_audit_review"
DEFAULT_KEY = "v311.02-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V311.02"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V311.02 production live audit and save proof results.")
