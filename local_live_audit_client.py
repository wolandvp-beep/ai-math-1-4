#!/usr/bin/env python3
"""Run the V296.12 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v296.12_live_g1_arithmetic_actions_semantic_single_step_ui"
DEFAULT_KEY = "v296.12-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V296.12"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V296.12 production live audit and save proof results.")
