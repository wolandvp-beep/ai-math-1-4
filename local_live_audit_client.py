...
DEFAULT_RELEASE = "v306_live_g3_arithmetic_actions"
DEFAULT_KEY = "v306-live-audit"
...
def main() -> int:
    ...
    parser.add_argument("--out", default="v306_live_audit_result.json", help="Output JSON file")
