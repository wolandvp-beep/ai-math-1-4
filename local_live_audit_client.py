...
DEFAULT_RELEASE = "v308_live_g3_geometry_area_perimeter"
DEFAULT_KEY = "v308-live-audit"
...
def main() -> int:
    ...
    parser.add_argument("--out", default="v308_live_audit_result.json", help="Output JSON file")
