#!/usr/bin/env python3
"""Run the V311.01 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v311.01_live_g4_arithmetic_equations_columnar_explanations"
DEFAULT_KEY = "v311.01-live-audit"
DEFAULT_SECTION = "g4_arithmetic_actions"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V311.01"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V311.01 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v309_live_audit_result.json", help="Output JSON file")
