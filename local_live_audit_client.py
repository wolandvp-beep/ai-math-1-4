#!/usr/bin/env python3
"""Run the V300 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v300.01_live_g2_numbers_quantities_deepseek_retry_and_cost_ui_fix"
DEFAULT_KEY = "v300.01-live-audit"
DEFAULT_SECTION = "g2_numbers_quantities"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V300"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V300 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v300_live_audit_result.json", help="Output JSON file")
