#!/usr/bin/env python3
"""Run the V317 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v317_live_app_quality_regression"
DEFAULT_KEY = "v317-live-audit"
DEFAULT_SECTION = "app_quality_regression"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V317"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V317 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v317_live_audit_result.json", help="Output JSON file")
