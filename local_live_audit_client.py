#!/usr/bin/env python3
"""Run the V314.1 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v314.1_live_g4_math_information"
DEFAULT_KEY = "v314.1-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V314.1"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V314.1 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v314.1_live_audit_result.json", help="Output JSON file")
