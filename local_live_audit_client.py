#!/usr/bin/env python3
"""Run the V296.03 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v296.03_live_g1_arithmetic_actions_proof_audit"
DEFAULT_KEY = "v296.03-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V296.03"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V296.03 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v296_03_live_audit_result.json", help="Output JSON file")
