#!/usr/bin/env python3
"""Run the V315 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v315_live_g4_final_regression"
DEFAULT_KEY = "v315-live-audit"
DEFAULT_SECTION = "g4_final_regression"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V315"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V315 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v315_live_audit_result.json", help="Output JSON file")
