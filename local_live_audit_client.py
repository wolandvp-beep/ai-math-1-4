#!/usr/bin/env python3
"""Run the V297.04 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v297.04_live_g1_text_problems_case_text_quality_fix"
DEFAULT_KEY = "v297.04-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V297.04"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V297.04 production live audit and save proof results.")
