#!/usr/bin/env python3
"""Run the V298.01 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v298.01_live_g1_geometry_spatial_relations_postprocess_fix"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V298.01"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V298.01 production live audit and save proof results.")
