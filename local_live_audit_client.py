#!/usr/bin/env python3
"""Run the V301 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v301.03_live_g2_arithmetic_actions_backend_visible_result"
DEFAULT_KEY = "v301.03-live-audit"
DEFAULT_SECTION = "g2_arithmetic_actions"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V301"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V301 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v301_live_audit_result.json", help="Output JSON file")
