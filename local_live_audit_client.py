#!/usr/bin/env python3
"""Run the V297.02 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v297.02_live_g1_text_problems_multitask_and_case_fix"
DEFAULT_KEY = "v297.02-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V297.02"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V297.02 production live audit and save proof results.")
