#!/usr/bin/env python3
"""Run the V311.04 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v311.04_live_g4_arithmetic_solution_flow_replay_scroll"
DEFAULT_KEY = "v311.04-live-audit"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V311.04"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V311.04 production live audit and save proof results.")
