#!/usr/bin/env python3
"""Run the V309 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v309.04_live_g3_math_information_route_frontend_canonical"
DEFAULT_KEY = "v309.04-live-audit"
DEFAULT_SECTION = "g3_math_information"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V309"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V309 production live audit and save proof results.")
