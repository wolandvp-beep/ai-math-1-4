#!/usr/bin/env python3
"""Run the V303 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v303.01_live_g2_geometry_length_conversion_contract_fix"
DEFAULT_KEY = "v303.01-live-audit"
DEFAULT_SECTION = "g2_geometry"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V303"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V303 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v303_live_audit_result.json", help="Output JSON file")
