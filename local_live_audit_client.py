#!/usr/bin/env python3
"""Run the V298.02 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v298.02_live_g1_geometry_spatial_relations_input_alignment_fix"
DEFAULT_KEY = "v298.02-live-audit"
DEFAULT_SECTION = "g1_geometry_spatial"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V298.02"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V298.02 production live audit and save proof results.")
