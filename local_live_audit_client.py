#!/usr/bin/env python3
"""Run the V304 live audit from an operator computer and save proof JSON.
...
DEFAULT_RELEASE = "v304.01_live_g2_math_information_parser_contract_fix"
DEFAULT_KEY = "v304.01-live-audit"
DEFAULT_SECTION = "g2_math_information"
...
def get_json(url: str, timeout: float = 120.0) -> dict[str, Any]:
    req = Request(url, headers={"User-Agent": "MathAuditLocalClient/V304"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V304 production live audit and save proof results.")
    ...
    parser.add_argument("--out", default="v304_live_audit_result.json", help="Output JSON file")
