...
Всегда используй слово "Совет", а не "Запомни" и не "Памятка".
...
10. В конце дай очень короткий совет, который ребёнок сможет перенести на похожие задачи.
...
Значит, стало 6.
Ответ: 6.
Совет: если что-то добавили или подарили, обычно нужно складывать.
