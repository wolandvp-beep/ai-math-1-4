...
# BOOK_METHOD_PATCH_V14_IMPORT
import importlib.util as _book_patch_importlib_util
from pathlib import Path as _BookPatchPath
_book_patch_path = _BookPatchPath(__file__).with_name('book_patch_v14_helper.py')
_book_patch_spec = _book_patch_importlib_util.spec_from_file_location('book_patch_v14_helper', _book_patch_path)
_book_patch_mod = _book_patch_importlib_util.module_from_spec(_book_patch_spec)
_book_patch_spec.loader.exec_module(_book_patch_mod)
_book_patch_mod.apply_book_patch_v14(globals())

# BOOK_METHOD_PATCH_V15_IMPORT
import importlib.util as _book_patch_v15_importlib_util
from pathlib import Path as _BookPatchV15Path
_book_patch_v15_path = _BookPatchV15Path(__file__).with_name('book_patch_v15_helper.py')
_book_patch_v15_spec = _book_patch_v15_importlib_util.spec_from_file_location('book_patch_v15_helper', _book_patch_v15_path)
_book_patch_v15_mod = _book_patch_v15_importlib_util.module_from_spec(_book_patch_v15_spec)
_book_patch_v15_spec.loader.exec_module(_book_patch_v15_mod)
_book_patch_v15_mod.apply_book_patch_v15(globals())
