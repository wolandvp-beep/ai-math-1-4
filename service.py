...
APP_RELEASE = 'v311.01_live_g4_arithmetic_equations_columnar_explanations'
SOLVER_VERSION = 'v311.01-live-g4-arithmetic-equations-columnar-explanations'
...
def _v311_try_equation(original_text: str) -> dict | None:
    ...
    def equation_payload(value: int, component: str, rule: str, numeric_step: str, conclusion: str | None = None) -> dict:
        final = f'x = {value}'
        steps = [
            f'В уравнении {eq} неизвестное число x — это {component}',
            rule,
            numeric_step,
            conclusion or f'Значит, x = {value}',
        ]
