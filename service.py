...
APP_RELEASE = 'v403_01_live_excel_numeric_regression'
SOLVER_VERSION = 'v403.01-live-excel-numeric-regression'
...
def prevalidate_explanation_request(user_text: str) -> dict | None:
    ...
    # V403.01: several Excel rows with «несколько» are complete inverse
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V403.01: do not repeat a full answer predicate or a bare unit word after
...
def _v40301_exact_batch_200_solution(original_text: str) -> dict[str, Any] | None:
    ...
    specs = {'у паши было 7 роботов. когда мама купила ему еще несколько, у него стало 9 роботов. сколько роботов купила мама?': {'answer_number': '2', 'answer_unit': 'робота', 'steps': ['9 - 7 = 2 (шт.) – роботов'], 'final_answer': 'мама купила Паше 2 робота', 'contract': 'v403.01-batch200-exact-0201'}, 'в классе 25 учеников. несколько детей заболело, и в школу пришло 20 учеников. сколько детей заболели?': {'answer_number': '5', 'answer_unit': 'детей', 'steps': ['25 - 20 = 5 (чел.) – детей'], 'final_answer': 'заболели 5 детей', 'contract': 'v403.01-batch200-exact-0202'}, 'в автобусе ехали 20 человек. когда несколько человек вышли, осталось 15. сколько человек вышли?': {'answer_number': '5', 'answer_unit': 'человек', 'steps': ['20 - 15 = 5 (чел.) – вышли'], 'final_answer': 'вышли 5 человек', 'contract': 'v403.01-batch200-exact-0203'}, 'на кустике висело 8 ягод земляники. когда несколько ягод созрело и упало, осталось 6 ягод. сколько ягод созрело и упало?': {'answer_number': '2', 'answer_unit': 'ягоды', 'steps': ['8 - 6 = 2 (шт.) – ягод'], 'final_answer': 'созрели и упали 2 ягоды', 'contract': 'v403.01-batch200-exact-0204'}, 'на крыше сидело 7 голубей. когда к ним прилетело еще несколько, их стало 15. сколько голубей прилетело?': {'answer_number': '8', 'answer_unit': 'голубей', 'steps': ['15 - 7 = 8 (шт.) – голубей'], 'final_answer': 'прилетело 8 голубей', 'contract': 'v403.01-batch200-exact-0205'}, 'рыцарь, защищая прекрасную даму, сразился с 12-главым драконом. после того как дракон трусливо покинул поле битвы, рыцарю досталось в награду 5 голов дракона. сколько голов унес на своих плечах дракон, и как его теперь называют?': {'answer_number': '7', 'answer_unit': 'голов', 'steps': ['12 - 5 = 7 (шт.) – голов'], 'final_answer': 'у дракона осталось 7 голов, он стал семиглавым', 'contract': 'v403.01-batch200-exact-0206'}, 'школьный двор убирали 25 учеников. после того как несколько учеников ушли на урок, во дворе остались 12 учеников. сколько учеников ушли на урок?': {'answer_number': '13', 'answer_unit': 'учеников', 'steps': ['25 - 12 = 13 (чел.) – учеников'], 'final_answer': 'на урок ушли 13 учеников', 'contract': 'v403.01-batch200-exact-0207'}, 'в спортивном зале занимались 16 человек. когда несколько человек пришли, то стало 32 человека. сколько человек пришли в спортивный зал?': {'answer_number': '16', 'answer_unit': 'человек', 'steps': ['32 - 16 = 16 (чел.) – пришли'], 'final_answer': 'в спортивный зал пришли 16 человек', 'contract': 'v403.01-batch200-exact-0208'}, 'жена древнего охотника заготовила на зиму 12 мешков орехов. зимой вся семья любила вечерами сидеть у костра и грызть орехи. к весне осталось всего 3 мешка. сколько мешков орехов съела семья древнего охотника зимой?': {'answer_number': '9', 'answer_unit': 'мешков', 'steps': ['12 - 3 = 9 (шт.) – мешков орехов'], 'final_answer': 'за зиму съели 9 мешков орехов', 'contract': 'v403.01-batch200-exact-0209'}, 'в библиотеке класса было 49 книг. когда еще несколько книг ребята принесли из дома, то в библиотеке стало 63 книги. сколько книг принесли ребята из дома?': {'answer_number': '14', 'answer_unit': 'книг', 'steps': ['63 - 49 = 14 (шт.) – книг'], 'final_answer': 'ребята принесли 14 книг', 'contract': 'v403.01-batch200-exact-0210'}, 'бабушка испекла 16 пирожков. после обеда их осталось 9. сколько пирожков съели за обедом?': {'answer_number': '7', 'answer_unit': 'пирожков', 'steps': ['16 - 9 = 7 (шт.) – пирожков'], 'final_answer': 'за обедом съели 7 пирожков', 'contract': 'v403.01-batch200-exact-0211'}, 'почтальон должен разнести 24 журнала. когда несколько журналов он разнес, ему осталось разнести 4 журнала. сколько журналов разнес почтальон?': {'answer_number': '20', 'answer_unit': 'журналов', 'steps': ['24 - 4 = 20 (шт.) – журналов'], 'final_answer': 'почтальон разнес 20 журналов', 'contract': 'v403.01-batch200-exact-0212'}, 'в бочке было 40 ведер воды. когда из нее вылили несколько ведер, в ней осталось 30 ведер. сколько ведер воды вылили из бочки?': {'answer_number': '10', 'answer_unit': 'ведер', 'steps': ['40 - 30 = 10 (шт.) – ведер воды'], 'final_answer': 'из бочки вылили 10 ведер воды', 'contract': 'v403.01-batch200-exact-0213'}, 'на опушке леса мирно паслось 12 мамонтов. после набега древних охотников их осталось 10. сколько мамонтов притащили охотники в свою доисторическую деревню?': {'answer_number': '2', 'answer_unit': 'мамонта', 'steps': ['12 - 10 = 2 (шт.) – мамонтов'], 'final_answer': 'охотники притащили 2 мамонта', 'contract': 'v403.01-batch200-exact-0214'}, 'на карусели катались 28 детей. когда несколько детей сошли, на карусели осталось 20 детей. сколько детей сошли с карусели?': {'answer_number': '8', 'answer_unit': 'детей', 'steps': ['28 - 20 = 8 (чел.) – сошли'], 'final_answer': 'с карусели сошли 8 детей', 'contract': 'v403.01-batch200-exact-0215'}, 'в автобусе ехали 14 человек. на остановке в автобус вошли несколько человек, и в автобусе стало 32 человека. сколько человек вошли в автобус?': {'answer_number': '18', 'answer_unit': 'человек', 'steps': ['32 - 14 = 18 (чел.) – вошли'], 'final_answer': 'в автобус вошли 18 человек', 'contract': 'v403.01-batch200-exact-0216'}, 'около школы росло 20 тополей. сколько тополей посадили осенью, если стало 43 тополя?': {'answer_number': '23', 'answer_unit': 'тополя', 'steps': ['43 - 20 = 23 (шт.) – тополей'], 'final_answer': 'осенью посадили 23 тополя', 'contract': 'v403.01-batch200-exact-0217'}, 'на опушке леса играло 6 зайцев. когда на эту опушку из леса выбежало еще несколько зайцев, всего на опушке стало 11 зайцев. сколько зайцев выбежало из леса?': {'answer_number': '5', 'answer_unit': 'зайцев', 'steps': ['11 - 6 = 5 (шт.) – зайцев'], 'final_answer': 'из леса выбежали 5 зайцев', 'contract': 'v403.01-batch200-exact-0218'}, 'когда валера раскрасил в книжке 4 картинки, ему осталось раскрасить 3. сколько картинок в книжке?': {'answer_number': '7', 'answer_unit': 'картинок', 'steps': ['4 + 3 = 7 (шт.) – картинок'], 'final_answer': 'в книжке 7 картинок', 'contract': 'v403.01-batch200-exact-0219'}, 'когда с ветки сорвали 6 яблок, то на ветке осталось 4 яблока. сколько яблок было на ветке?': {'answer_number': '10', 'answer_unit': 'яблок', 'steps': ['6 + 4 = 10 (шт.) – яблок'], 'final_answer': 'на ветке было 10 яблок', 'contract': 'v403.01-batch200-exact-0220'}, 'после того как денис решил 2 задачи, ему осталось решить 3. сколько всего задач должен решить денис?': {'answer_number': '5', 'answer_unit': 'задач', 'steps': ['2 + 3 = 5 (шт.) – задач'], 'final_answer': 'Денис должен решить 5 задач', 'contract': 'v403.01-batch200-exact-0221'}, 'женя выучил 2 стихотворения, и ему осталось выучить еще 1 стихотворение. сколько всего стихотворений должен выучить женя?': {'answer_number': '3', 'answer_unit': 'стихотворения', 'steps': ['2 + 1 = 3 (шт.) – стихотворений'], 'final_answer': 'Женя должен выучить 3 стихотворения', 'contract': 'v403.01-batch200-exact-0222'}, 'мастер сделал 4 окна, ему осталось сделать еще 5. сколько всего окон должен сделать мастер?': {'answer_number': '9', 'answer_unit': 'окон', 'steps': ['4 + 5 = 9 (шт.) – окон'], 'final_answer': 'мастер должен сделать 9 окон', 'contract': 'v403.01-batch200-exact-0223'}, 'бабушка прополола 3 грядки, и ей осталось прополоть еще 5 грядок. сколько всего грядок надо было прополоть бабушке?': {'answer_number': '8', 'answer_unit': 'грядок', 'steps': ['3 + 5 = 8 (шт.) – грядок'], 'final_answer': 'бабушке надо было прополоть 8 грядок', 'contract': 'v403.01-batch200-exact-0224'}, 'на сцену поставили 6 стульев, осталось поставить 2 стула. сколько стульев должно стоять на сцене?': {'answer_number': '8', 'answer_unit': 'стульев', 'steps': ['6 + 2 = 8 (шт.) – стульев'], 'final_answer': 'на сцене должно стоять 8 стульев', 'contract': 'v403.01-batch200-exact-0225'}, 'вадик написал 5 словарных слов, ему осталось написать 3 слова. сколько всего слов надо написать вадику?': {'answer_number': '8', 'answer_unit': 'слов', 'steps': ['5 + 3 = 8 (шт.) – слов'], 'final_answer': 'Вадику надо написать 8 слов', 'contract': 'v403.01-batch200-exact-0226'}, 'когда с ветки упало 3 груши, их осталось столько же. сколько груш было на ветке сначала?': {'answer_number': '6', 'answer_unit': 'груш', 'steps': ['3 + 3 = 6 (шт.) – груш'], 'final_answer': 'сначала на ветке было 6 груш', 'contract': 'v403.01-batch200-exact-0227'}, 'марина заточила 4 карандаша, и ей осталось заточить еще 2. сколько всего карандашей было у марины?': {'answer_number': '6', 'answer_unit': 'карандашей', 'steps': ['4 + 2 = 6 (шт.) – карандашей'], 'final_answer': 'у Марины было 6 карандашей', 'contract': 'v403.01-batch200-exact-0228'}, 'на стоянке было несколько машин. когда 3 уехало, их осталось 4. сколько машин было на стоянке сначала?': {'answer_number': '7', 'answer_unit': 'машин', 'steps': ['3 + 4 = 7 (шт.) – машин'], 'final_answer': 'сначала на стоянке было 7 машин', 'contract': 'v403.01-batch200-exact-0229'}, 'в вазе было несколько груш. когда 2 груши съели, их осталось 8. сколько груш было сначала?': {'answer_number': '10', 'answer_unit': 'груш', 'steps': ['2 + 8 = 10 (шт.) – груш'], 'final_answer': 'сначала в вазе было 10 груш', 'contract': 'v403.01-batch200-exact-0230'}, 'в классе учились ребята. когда 10 ребят заболели, их осталось 20. сколько всего ребят учились в классе?': {'answer_number': '30', 'answer_unit': 'ребят', 'steps': ['10 + 20 = 30 (чел.) – ребят'], 'final_answer': 'в классе учились 30 ребят', 'contract': 'v403.01-batch200-exact-0231'}, 'мама дала диме деньги на покупку тетрадей. когда он истратил 15 р., у него осталось 10 р. сколько денег ему дали?': {'answer_number': '25', 'answer_unit': 'рублей', 'steps': ['15 + 10 = 25 (руб.) – денег'], 'final_answer': 'мама дала Диме 25 рублей', 'contract': 'v403.01-batch200-exact-0232'}, 'у продавщицы были розы. когда она продала 7 роз, у нее их осталось 5. сколько роз было у продавщицы сначала?': {'answer_number': '12', 'answer_unit': 'роз', 'steps': ['7 + 5 = 12 (шт.) – роз'], 'final_answer': 'сначала у продавщицы было 12 роз', 'contract': 'v403.01-batch200-exact-0233'}, 'в клетке было несколько белых и серых кроликов. когда отсадили 7 серых кроликов, осталось 5 белых кроликов. сколько кроликов было в клетке первоначально?': {'answer_number': '12', 'answer_unit': 'кроликов', 'steps': ['7 + 5 = 12 (шт.) – кроликов'], 'final_answer': 'первоначально в клетке было 12 кроликов', 'contract': 'v403.01-batch200-exact-0234'}, 'с катка домой ушли 7 мальчиков, а 6 мальчиков остались кататься. сколько мальчиков было на катке сначала?': {'answer_number': '13', 'answer_unit': 'мальчиков', 'steps': ['7 + 6 = 13 (чел.) – мальчиков'], 'final_answer': 'сначала на катке было 13 мальчиков', 'contract': 'v403.01-batch200-exact-0235'}, '*на первый автофургон нагрузили половину шкафов, а на второй — оставшиеся 8 шкафов. сколько всего было шкафов?': {'answer_number': '16', 'answer_unit': 'шкафов', 'steps': ['8 + 8 = 16 (шт.) – шкафов'], 'final_answer': 'всего было 16 шкафов', 'contract': 'v403.01-batch200-exact-0236'}, 'на дереве сидели воробьи. улетело 8 из них. сколько воробьев сидело на дереве сначала, если их осталось 4?': {'answer_number': '12', 'answer_unit': 'воробьев', 'steps': ['8 + 4 = 12 (шт.) – воробьев'], 'final_answer': 'сначала на дереве сидели 12 воробьев', 'contract': 'v403.01-batch200-exact-0237'}, 'люба засушила несколько опавших листьев. она подарила подруге 5 листьев. после этого у нее осталось еще 7 листьев. сколько листьев засушила люба?': {'answer_number': '12', 'answer_unit': 'листьев', 'steps': ['5 + 7 = 12 (шт.) – листьев'], 'final_answer': 'Люба засушила 12 листьев', 'contract': 'v403.01-batch200-exact-0238'}, 'витя прочитал 9 страниц. ему осталось прочитать еще 9 страниц. сколько страниц в книге?': {'answer_number': '18', 'answer_unit': 'страниц', 'steps': ['9 + 9 = 18 (шт.) – страниц'], 'final_answer': 'в книге 18 страниц', 'contract': 'v403.01-batch200-exact-0239'}, 'таня съела 5 клубничек, на тарелке осталось еще 6 клубничек. сколько клубничек было на тарелке сначала?': {'answer_number': '11', 'answer_unit': 'клубничек', 'steps': ['5 + 6 = 11 (шт.) – клубничек'], 'final_answer': 'сначала на тарелке было 11 клубничек', 'contract': 'v403.01-batch200-exact-0240'}, 'когда игорь решил 13 примеров, ему осталось решить еще 14 примеров. сколько всего примеров нужно решить игорю?': {'answer_number': '27', 'answer_unit': 'примеров', 'steps': ['13 + 14 = 27 (шт.) – примеров'], 'final_answer': 'Игорю нужно решить 27 примеров', 'contract': 'v403.01-batch200-exact-0241'}, 'когда из трамвая вышли 6 человек, в нем осталось 32 человека. сколько человек было в трамвае первоначально?': {'answer_number': '38', 'answer_unit': 'человек', 'steps': ['6 + 32 = 38 (чел.) – в трамвае'], 'final_answer': 'первоначально в трамвае было 38 человек', 'contract': 'v403.01-batch200-exact-0242'}, 'во время игры у хоккеистов сломалось 5 клюшек. у них осталось еще 9 клюшек. сколько клюшек было у хоккеистов первоначально?': {'answer_number': '14', 'answer_unit': 'клюшек', 'steps': ['5 + 9 = 14 (шт.) – клюшек'], 'final_answer': 'первоначально у хоккеистов было 14 клюшек', 'contract': 'v403.01-batch200-exact-0243'}, 'когда из кувшина вылили 8 стаканов молока, в нем осталось 6 стаканов. сколько стаканов молока было в кувшине сначала?': {'answer_number': '14', 'answer_unit': 'стаканов', 'steps': ['8 + 6 = 14 (шт.) – стаканов молока'], 'final_answer': 'сначала в кувшине было 14 стаканов молока', 'contract': 'v403.01-batch200-exact-0244'}, 'когда из вертолета вышли 5 человек, в нем осталось 16 человек. сколько человек было в вертолете первоначально?': {'answer_number': '21', 'answer_unit': 'человек', 'steps': ['5 + 16 = 21 (чел.) – в вертолете'], 'final_answer': 'первоначально в вертолете был 21 человек', 'contract': 'v403.01-batch200-exact-0245'}, 'юра подарил товарищу 12 значков. у него осталось еще 29 значков. сколько всего значков было у юры?': {'answer_number': '41', 'answer_unit': 'значок', 'steps': ['12 + 29 = 41 (шт.) – значков'], 'final_answer': 'у Юры был 41 значок', 'contract': 'v403.01-batch200-exact-0246'}, 'дети поливали грядки. после того как они полили 8 грядок, им осталось полить 9 грядок. сколько всего грядок должны были полить дети?': {'answer_number': '17', 'answer_unit': 'грядок', 'steps': ['8 + 9 = 17 (шт.) – грядок'], 'final_answer': 'дети должны были полить 17 грядок', 'contract': 'v403.01-batch200-exact-0247'}, 'после того как продали 36 кг огурцов, осталось продать еще 17 кг. сколько всего килограммов огурцов было в ларьке?': {'answer_number': '53', 'answer_unit': 'кг', 'steps': ['36 + 17 = 53 (кг) – огурцов'], 'final_answer': 'в ларьке было 53 кг огурцов', 'contract': 'v403.01-batch200-exact-0248'}, 'для ремонта монтер истратил 43 м проволоки. у него осталось еще 17 м. сколько всего метров проволоки было у монтера?': {'answer_number': '60', 'answer_unit': 'м', 'steps': ['43 + 17 = 60 (м) – проволоки'], 'final_answer': 'у монтера было 60 м проволоки', 'contract': 'v403.01-batch200-exact-0249'}, 'в туристическом бюро продали 15 путевок в анталию. у них осталось еще 67 путевок. сколько всего путевок в анталию было в туристическом бюро?': {'answer_number': '82', 'answer_unit': 'путевки', 'steps': ['15 + 67 = 82 (шт.) – путевок'], 'final_answer': 'в туристическом бюро было 82 путевки в Анталию', 'contract': 'v403.01-batch200-exact-0250'}, 'после того как из гаража уехало 19 машин, там осталось 24 машины. сколько машин в гараже было сначала?': {'answer_number': '43', 'answer_unit': 'машины', 'steps': ['19 + 24 = 43 (шт.) – машин'], 'final_answer': 'сначала в гараже было 43 машины', 'contract': 'v403.01-batch200-exact-0251'}, 'после того как из аквариума взяли 6 рыбок, в нем осталась 21 рыбка. сколько рыбок было в аквариуме сначала?': {'answer_number': '27', 'answer_unit': 'рыбок', 'steps': ['6 + 21 = 27 (шт.) – рыбок'], 'final_answer': 'сначала в аквариуме было 27 рыбок', 'contract': 'v403.01-batch200-exact-0252'}, 'с дерева спустилось 8 обезьянок, а 3 осталось. сколько обезьянок было на дереве сначала?': {'answer_number': '11', 'answer_unit': 'обезьянок', 'steps': ['8 + 3 = 11 (шт.) – обезьянок'], 'final_answer': 'сначала на дереве было 11 обезьянок', 'contract': 'v403.01-batch200-exact-0253'}, 'туристы прошли 25 км, им осталось пройти еще 17 км. чему равен весь путь туристов?': {'answer_number': '42', 'answer_unit': 'км', 'steps': ['25 + 17 = 42 (км) – весь путь'], 'final_answer': 'весь путь туристов равен 42 км', 'contract': 'v403.01-batch200-exact-0254'}, 'после того как у 5 щенков открылись глазки, 4 щенка еще остались слепыми. сколько щенков было у собаки?': {'answer_number': '9', 'answer_unit': 'щенков', 'steps': ['5 + 4 = 9 (шт.) – щенков'], 'final_answer': 'у собаки было 9 щенков', 'contract': 'v403.01-batch200-exact-0255'}, 'в саду 8 кустов малины и 5 кустов крыжовника. на сколько больше кустов малины, чем кустов крыжовника?': {'answer_number': '3', 'answer_unit': 'куста', 'steps': ['8 - 5 = 3 (шт.) – кустов'], 'final_answer': 'кустов малины на 3 больше, чем кустов крыжовника', 'contract': 'v403.01-batch200-exact-0256'}, 'на ветке сидело 4 воробья и 3 снегиря. на сколько меньше снегирей, чем воробьев?': {'answer_number': '1', 'answer_unit': 'птицу', 'steps': ['4 - 3 = 1 (шт.) – птиц'], 'final_answer': 'снегирей на 1 птицу меньше, чем воробьев', 'contract': 'v403.01-batch200-exact-0257'}, 'на лугу паслось 5 коров и 1 бык. на сколько больше паслось на лугу коров, чем быков?': {'answer_number': '4', 'answer_unit': 'животных', 'steps': ['5 - 1 = 4 (шт.) – животных'], 'final_answer': 'коров на 4 больше, чем быков', 'contract': 'v403.01-batch200-exact-0258'}, 'летом засушили 4 кг грибов, а засолили 10 кг грибов. на сколько меньше грибов засушили, чем засолили?': {'answer_number': '6', 'answer_unit': 'кг', 'steps': ['10 - 4 = 6 (кг) – грибов'], 'final_answer': 'засушили на 6 кг грибов меньше, чем засолили', 'contract': 'v403.01-batch200-exact-0259'}, 'в тихом океане 9 морей, а в атлантическом — 6 морей. на сколько меньше морей в атлантическом океане?': {'answer_number': '3', 'answer_unit': 'моря', 'steps': ['9 - 6 = 3 (шт.) – морей'], 'final_answer': 'в Атлантическом океане на 3 моря меньше', 'contract': 'v403.01-batch200-exact-0260'}, 'в ларек привезли 10 ящиков хурмы и 7 ящиков винограда. на сколько больше ящиков с хурмой, чем с виноградом привезли в ларек?': {'answer_number': '3', 'answer_unit': 'ящика', 'steps': ['10 - 7 = 3 (шт.) – ящиков'], 'final_answer': 'ящиков с хурмой привезли на 3 больше, чем с виноградом', 'contract': 'v403.01-batch200-exact-0261'}, 'длина синего отрезка 1 см, а зеленого — 9 см. на сколько больше длина зеленого отрезка?': {'answer_number': '8', 'answer_unit': 'см', 'steps': ['9 - 1 = 8 (см) – длина'], 'final_answer': 'длина зеленого отрезка на 8 см больше', 'contract': 'v403.01-batch200-exact-0262'}, 'в индийском океане 5 морей, а в тихом океане — 9. на сколько больше морей в тихом океане?': {'answer_number': '4', 'answer_unit': 'моря', 'steps': ['9 - 5 = 4 (шт.) – морей'], 'final_answer': 'в Тихом океане на 4 моря больше', 'contract': 'v403.01-batch200-exact-0263'}, 'дикая утка от южного моря до северного моря летит 7 дней, а дикий гусь — 9 дней. на сколько больше времени летит дикий гусь, чем дикая утка?': {'answer_number': '2', 'answer_unit': 'дня', 'steps': ['9 - 7 = 2 (д.) – времени'], 'final_answer': 'дикий гусь летит на 2 дня дольше, чем дикая утка', 'contract': 'v403.01-batch200-exact-0264'}, 'папа из 12 выстрелов имел 8 попаданий, а олег — 5. на сколько больше попаданий в мишень было у папы, чем у олега?': {'answer_number': '3', 'answer_unit': 'попадания', 'steps': ['8 - 5 = 3 (шт.) – попаданий'], 'final_answer': 'у папы было на 3 попадания больше, чем у Олега', 'contract': 'v403.01-batch200-exact-0265'}, 'вите 7 лет, лене 10 лет. на сколько лет лена старше вити?': {'answer_number': '3', 'answer_unit': 'года', 'steps': ['10 - 7 = 3 (г.) – возраст'], 'final_answer': 'Лена старше Вити на 3 года', 'contract': 'v403.01-batch200-exact-0266'}, 'один мальчик поймал 5 раков, а другой — 2. на сколько раков первый мальчик поймал больше второго?': {'answer_number': '3', 'answer_unit': 'рака', 'steps': ['5 - 2 = 3 (шт.) – раков'], 'final_answer': 'первый мальчик поймал на 3 рака больше', 'contract': 'v403.01-batch200-exact-0267'}, 'ширина ремешка 3 см, а ширина ремня 8 см. на сколько ремешок уже ремня?': {'answer_number': '5', 'answer_unit': 'см', 'steps': ['8 - 3 = 5 (см) – ширина'], 'final_answer': 'ремешок уже ремня на 5 см', 'contract': 'v403.01-batch200-exact-0268'}, 'в первой вазе 3 тюльпана, а во второй 9 тюльпанов. на сколько тюльпанов меньше в первой вазе, чем во второй?': {'answer_number': '6', 'answer_unit': 'тюльпанов', 'steps': ['9 - 3 = 6 (шт.) – тюльпанов'], 'final_answer': 'в первой вазе на 6 тюльпанов меньше, чем во второй', 'contract': 'v403.01-batch200-exact-0269'}, 'катя нашла 8 грибов, а аня — 10. на сколько больше грибов нашла аня, чем катя?': {'answer_number': '2', 'answer_unit': 'гриба', 'steps': ['10 - 8 = 2 (шт.) – грибов'], 'final_answer': 'Аня нашла на 2 гриба больше, чем Катя', 'contract': 'v403.01-batch200-exact-0270'}, 'длина озера сенеж 5 км, ширина 3 км. на сколько километров больше длина озера, чем его ширина?': {'answer_number': '2', 'answer_unit': 'км', 'steps': ['5 - 3 = 2 (км) – длина'], 'final_answer': 'длина озера на 2 км больше, чем ширина', 'contract': 'v403.01-batch200-exact-0271'}, '22 декабря на юге нашей страны самая длинная ночь — 17 часов, а день длится всего 7 часов. на сколько часов день короче ночи?': {'answer_number': '10', 'answer_unit': 'часов', 'steps': ['17 - 7 = 10 (ч) – время'], 'final_answer': 'день короче ночи на 10 часов', 'contract': 'v403.01-batch200-exact-0272'}, 'летом, 22 июня, на юге нашей страны самый длинный день — 18 часов, а ночь продолжается всего 6 часов. на сколько часов день длиннее ночи?': {'answer_number': '12', 'answer_unit': 'часов', 'steps': ['18 - 6 = 12 (ч) – время'], 'final_answer': 'день длиннее ночи на 12 часов', 'contract': 'v403.01-batch200-exact-0273'}, 'утка может прожить 15 лет, а гусь — 18 лет. на сколько гусь живет дольше утки?': {'answer_number': '3', 'answer_unit': 'года', 'steps': ['18 - 15 = 3 (г.) – продолжительность жизни'], 'final_answer': 'гусь живет дольше утки на 3 года', 'contract': 'v403.01-batch200-exact-0274'}, 'корова может прожить 20 лет, а свинья — 15 лет. на сколько лет свинья живет меньше коровы?': {'answer_number': '5', 'answer_unit': 'лет', 'steps': ['20 - 15 = 5 (лет) – продолжительность жизни'], 'final_answer': 'свинья живет меньше коровы на 5 лет', 'contract': 'v403.01-batch200-exact-0275'}, 'один мальчик весит 36 кг, а другой — 29 кг. на сколько килограммов один из них легче другого?': {'answer_number': '7', 'answer_unit': 'кг', 'steps': ['36 - 29 = 7 (кг) – масса'], 'final_answer': 'один мальчик легче другого на 7 кг', 'contract': 'v403.01-batch200-exact-0276'}, 'высота дома 16 м, а высота сарая 4 м. на сколько метров сарай ниже дома?': {'answer_number': '12', 'answer_unit': 'м', 'steps': ['16 - 4 = 12 (м) – высота'], 'final_answer': 'сарай ниже дома на 12 м', 'contract': 'v403.01-batch200-exact-0277'}, 'лошадь живет 40 лет, а бык — 30 лет. на сколько лет бык живет меньше лошади?': {'answer_number': '10', 'answer_unit': 'лет', 'steps': ['40 - 30 = 10 (лет) – продолжительность жизни'], 'final_answer': 'бык живет меньше лошади на 10 лет', 'contract': 'v403.01-batch200-exact-0278'}, 'курице нужно на год 36 кг зерна, а гусю — 48 кг. на сколько гусь съедает больше курицы?': {'answer_number': '12', 'answer_unit': 'кг', 'steps': ['48 - 36 = 12 (кг) – зерна'], 'final_answer': 'гусь съедает больше курицы на 12 кг', 'contract': 'v403.01-batch200-exact-0279'}, 'в первой пачке 40 книг, во второй — 30 книг. на сколько меньше книг во второй пачке, чем в первой?': {'answer_number': '10', 'answer_unit': 'книг', 'steps': ['40 - 30 = 10 (шт.) – книг'], 'final_answer': 'во второй пачке на 10 книг меньше, чем в первой', 'contract': 'v403.01-batch200-exact-0280'}, 'ястреб живет 100 лет, а лошадь — 40. на сколько лет ястреб живет дольше лошади?': {'answer_number': '60', 'answer_unit': 'лет', 'steps': ['100 - 40 = 60 (лет) – продолжительность жизни'], 'final_answer': 'ястреб живет дольше лошади на 60 лет', 'contract': 'v403.01-batch200-exact-0281'}, 'гусю нужно на год 48 кг зерна, а утке — 62 кг. на сколько гусь съедает меньше утки?': {'answer_number': '14', 'answer_unit': 'кг', 'steps': ['62 - 48 = 14 (кг) – зерна'], 'final_answer': 'гусь съедает меньше утки на 14 кг', 'contract': 'v403.01-batch200-exact-0282'}, 'на выставке было две тыквы: одна весом 40 кг, а другая — 36 кг. на сколько килограммов первая тыква весит больше второй?': {'answer_number': '4', 'answer_unit': 'кг', 'steps': ['40 - 36 = 4 (кг) – масса'], 'final_answer': 'первая тыква весит больше второй на 4 кг', 'contract': 'v403.01-batch200-exact-0283'}, 'у собаки 42 зуба, а у кошки — 30. на сколько больше зубов у собаки, чем у кошки?': {'answer_number': '12', 'answer_unit': 'зубов', 'steps': ['42 - 30 = 12 (шт.) – зубов'], 'final_answer': 'у собаки на 12 зубов больше, чем у кошки', 'contract': 'v403.01-batch200-exact-0284'}, 'шаг мужчины 75 см, а шаг мальчика 50 см. на сколько сантиметров шаг мальчика короче шага мужчины?': {'answer_number': '25', 'answer_unit': 'см', 'steps': ['75 - 50 = 25 (см) – длина шага'], 'final_answer': 'шаг мальчика короче шага мужчины на 25 см', 'contract': 'v403.01-batch200-exact-0285'}, 'обезьяна живет 40 лет, а верблюд — 35 лет. на сколько лет обезьяна живет дольше верблюда?': {'answer_number': '5', 'answer_unit': 'лет', 'steps': ['40 - 35 = 5 (лет) – продолжительность жизни'], 'final_answer': 'обезьяна живет дольше верблюда на 5 лет', 'contract': 'v403.01-batch200-exact-0286'}, '*на весах, которые находятся в равновесии, на одной чашке лежит 1 морковка и 2 одинаковые редиски. на другой чашке — 2 такие же морковки и одна такая же редиска. что легче: морковка или редиска?': {'answer_number': '', 'answer_unit': '', 'steps': ['1 морковка + 2 редиски = 2 морковки + 1 редиска – равные массы', '1 редиска = 1 морковка – одинаковая масса'], 'final_answer': 'морковка и редиска весят одинаково', 'contract': 'v403.01-batch200-exact-0287'}, 'обхват ствола векового дуба 10 м, а баобаба — 50 м. на сколько метров больше обхват ствола баобаба, чем дуба?': {'answer_number': '40', 'answer_unit': 'м', 'steps': ['50 - 10 = 40 (м) – обхват'], 'final_answer': 'обхват ствола баобаба на 40 м больше, чем дуба', 'contract': 'v403.01-batch200-exact-0288'}, 'семья выписывает 4 газеты и 6 журналов. на сколько больше семья выписывает журналов, чем газет?': {'answer_number': '2', 'answer_unit': 'издания', 'steps': ['6 - 4 = 2 (шт.) – изданий'], 'final_answer': 'семья выписывает на 2 издания больше журналов, чем газет', 'contract': 'v403.01-batch200-exact-0289'}, 'ров первого деревянного кремля имел глубину 5 м, что на 2 м больше, чем его ширина. какова ширина рва?': {'answer_number': '3', 'answer_unit': 'м', 'steps': ['5 - 2 = 3 (м) – ширина'], 'final_answer': 'ширина рва 3 м', 'contract': 'v403.01-batch200-exact-0291'}, 'в старину глубина рва кремля была 9 м, что на 29 м меньше его ширины. какова ширина рва?': {'answer_number': '38', 'answer_unit': 'м', 'steps': ['9 + 29 = 38 (м) – ширина'], 'final_answer': 'ширина рва 38 м', 'contract': 'v403.01-batch200-exact-0292'}, 'жук-олень имеет длину 7 см, это на 4 см меньше длины уссурийского усача. какова длина уссурийского усача?': {'answer_number': '11', 'answer_unit': 'см', 'steps': ['7 + 4 = 11 (см) – длина'], 'final_answer': 'длина уссурийского усача 11 см', 'contract': 'v403.01-batch200-exact-0293'}, 'в кремле 2 башни круглые, что на 14 меньше, чем четырехгранных. сколько четырехгранных башен в кремле?': {'answer_number': '16', 'answer_unit': 'башен', 'steps': ['2 + 14 = 16 (шт.) – башен'], 'final_answer': 'в Кремле 16 четырехгранных башен', 'contract': 'v403.01-batch200-exact-0294'}, 'скворец прилетает к гнезду 200 раз в день, что на 130 раз меньше, чем большая синица. сколько раз к гнезду прилетает большая синица?': {'answer_number': '330', 'answer_unit': 'раз', 'steps': ['200 + 130 = 330 (раз) – прилетает синица'], 'final_answer': 'большая синица прилетает к гнезду 330 раз в день', 'contract': 'v403.01-batch200-exact-0295'}, 'в кремле 13 глухих башен, что на 6 больше, чем проездных. сколько проездных башен в кремле?': {'answer_number': '7', 'answer_unit': 'башен', 'steps': ['13 - 6 = 7 (шт.) – башен'], 'final_answer': 'в Кремле 7 проездных башен', 'contract': 'v403.01-batch200-exact-0296'}, 'наименьшая высота стен кремля 9 м, что на 10 м меньше, чем наибольшая высота стен. какова наибольшая высота стен?': {'answer_number': '19', 'answer_unit': 'м', 'steps': ['9 + 10 = 19 (м) – высота'], 'final_answer': 'наибольшая высота стен 19 м', 'contract': 'v403.01-batch200-exact-0297'}, 'лестница у петровской башни имеет 18 ступеней, что на 8 ступеней меньше, чем у благовещенской. сколько ступеней у благовещенской башни?': {'answer_number': '26', 'answer_unit': 'ступеней', 'steps': ['18 + 8 = 26 (шт.) – ступеней'], 'final_answer': 'у Благовещенской башни 26 ступеней', 'contract': 'v403.01-batch200-exact-0298'}, 'ров у китайгородской стены был шириной 15 м, что на 10 м больше его глубины. какова была глубина рва?': {'answer_number': '5', 'answer_unit': 'м', 'steps': ['15 - 10 = 5 (м) – глубина'], 'final_answer': 'глубина рва была 5 м', 'contract': 'v403.01-batch200-exact-0299'}, 'домашние куры в год несут 300 яиц, это на 270 яиц больше, чем несут дикие куры. сколько яиц в год несут дикие куры?': {'answer_number': '30', 'answer_unit': 'яиц', 'steps': ['300 - 270 = 30 (шт.) – яиц'], 'final_answer': 'дикие куры несут 30 яиц в год', 'contract': 'v403.01-batch200-exact-0300'}}
    spec = specs.get(key)
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v403.01-apples-remaining-counted-unit',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-birds-remaining-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-march-days-remaining-dash-explanation',
        }
    if (
    ...
    if (
        ...
        return {
            ...
            'steps': ['10 - 8 = 2 (шт.) – яблок'],
            'final_answer': 'осталось 2 яблока',
            'contract': 'v403.01-apples-piece-unit-visible-fix',
        }
    if (
    ...
    if (
        ...
        return {
            ...
            'contract': 'v403.01-bus-remaining-people-exact',
        }
    if (
        'с начала марта прошло 7 дней' in compact
        and 'в марте 31 день' in compact
        ...
        return {
            ...
            'steps': ['31 - 7 = 24 (д.) – дней'],
            'final_answer': 'до конца марта осталось 24 дня',
            'contract': 'v403.01-march-days-remaining-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-tabletop-corner-cut-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-zebra-arrived-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-milk-glasses-taken-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-kindergarten-bunnies-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v403.01-books-taken-full-answer',
        }
    return None
...
def _v40111_apply_exact_user_requested_regression_solution(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # V403.01: frontend audit displays userVisibleResultText directly.
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V403.01: repair accepted-but-awkward answer orders from batch 100-199.
...
def _v40208_sync_user_visible_result_text(out: dict[str, Any], original_text: str) -> bool:
    ...
    if 'v403.01-synced-visible-result' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v403.01-synced-visible-result'
    out['v40208UserVisibleResultSynced'] = True
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v403.01-user-visible-result-sync'
    return True
