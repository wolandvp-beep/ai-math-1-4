...
APP_RELEASE = 'v298.01_live_g1_geometry_spatial_relations_postprocess_fix'
SOLVER_VERSION = 'v298.01-live-g1-geometry-spatial-relations-postprocess-fix'
...
def _looks_like_programmatic_math_text(text: str) -> bool:
    ...
    shape_description_markers = (
        any(phrase in src for phrase in (
            'нет углов',
            'без углов',
            'не имеет углов',
            'все стороны равны',
        ...
        and any(word in src for word in ('фигура', 'стороны', 'угла', 'углов', 'углами', 'углы'))
    )
    return bool(
