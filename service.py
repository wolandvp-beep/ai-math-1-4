...
APP_RELEASE = 'v409_live_excel_numeric_regression'
SOLVER_VERSION = 'v409-live-excel-numeric-regression'
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v409-live-excel-numeric-regression',
