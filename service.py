...
APP_RELEASE = 'v402_08_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.08-live-excel-numeric-regression'
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V402.08: do not repeat a full answer predicate or a bare unit word after
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.08-apples-remaining-counted-unit',
        }
    if (
    ...
    if (
        ...
        return {
            ...
            'steps': ['10 - 8 = 2 (шт.) – яблок'],
            'final_answer': 'осталось 2 яблока',
            'contract': 'v402.08-apples-piece-unit-visible-fix',
        }
    if (
...
def _v40111_apply_exact_user_requested_regression_solution(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # V402.08: frontend audit displays userVisibleResultText directly.
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V402.08: repair accepted-but-awkward answer orders from batch 100-199.
...
def _v40208_sync_user_visible_result_text(out: dict[str, Any], original_text: str) -> bool:
    ...
    if 'v402.08-synced-visible-result' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v402.08-synced-visible-result'
    out['v40208UserVisibleResultSynced'] = True
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v402.08-user-visible-result-sync'
    return True
