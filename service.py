...
APP_RELEASE = 'v408_01_live_excel_numeric_regression'
SOLVER_VERSION = 'v408.01-live-excel-numeric-regression'
...
# --- V408.01 exact real-API postprocess repairs for Excel batch 701-800 ---
_V40801_BATCH_701_800_SPECS = [('три верблюда весят d кг. вес первого верблюда b кг, второго - f кг. каков вес третьего верблюда?',
  ['b + f = b + f (кг) – вес первого и второго верблюдов', 'd - (b + f) = d - b - f (кг) – вес третьего верблюда'],
  'вес третьего верблюда d - b - f кг',
  'd - b - f',
  'кг',
  701,
  True),
 ('в школьную столовую привезли x пирожков с мясом и h пирожков с капустой. съели f пирожков. сколько пирожков осталось?',
  ['x + h = x + h (шт.) – всего пирожков', 'x + h - f = x + h - f (шт.) – осталось пирожков'],
 ...
 ('в питомнике было d овчарок и b борзых. когда часть собак продали, осталось w собак. сколько собак продали?',
  ['d + b = d + b (шт.) – всего собак', 'd + b - w = d + b - w (шт.) – продали собак'],
  'продали d + b - w собак',
  'd + b - w',
  'собак',
  703,
  True),
 ('для школы купили w магнитофонов, телевизоров - на z больше, чем магнитофонов, проигрывателей столько, сколько магнитофонов и телевизоров вместе. сколько '
  'проигрывателей купили для школы?',
  ...
  704,
  True),
 ('одна обувная фабрика за минуту выпускает р пар обуви, вторая - на п пар больше, чем первая, а третья - на f пар меньше, чем первая и вторая вместе. сколько '
  'всего пар обуви выпускают за минуту три фабрики?',
  ['p + n = p + n (шт.) – пар выпускает вторая фабрика',
   'p + (p + n) = p + p + n (шт.) – первая и вторая фабрики',
   'p + p + n - f = p + p + n - f (шт.) – пар выпускает третья фабрика',
   'p + (p + n) + (p + p + n - f) = p + (p + n) + (p + p + n - f) (шт.) – всего пар'],
  'три фабрики выпускают p + (p + n) + (p + p + n - f) пар обуви',
  'p + (p + n) + (p + p + n - f)',
  'пар',
  705,
  True),
 ('на аэродроме стояло x вертолетов, а cа-молетов - на r больше. сколько всего самолетов и вертолетов стояло на аэродроме?',
  ...
  706,
  True),
 ('дима потратил на выполнение домашнего задания по математике h мин, по русскому языку - на l мин больше, чем на выполнение заданий по математике, а по '
  'чтению - на g мин меньше, чем на задания по русскому языку. сколько минут потратил дима на выполнение заданий по чтению?',
  ['h + l = h + l (мин) – на русский язык', 'h + l - g = h + l - g (мин) – на чтение'],
  'Дима потратил на чтение h + l - g минут',
  'h + l - g',
  'минут',
  707,
  True),
 ('в доме творчества занимались f девочек и w мальчиков. когда пришли еще несколько человек, то в доме творчества стало z человек. сколько детей пришло?',
  ['f + w = f + w (чел.) – было детей', 'z - (f + w) = z - f - w (чел.) – пришло детей'],
  'в дом творчества пришло z - f - w детей',
  'z - f - w',
  'детей',
  708,
  True),
 ('в магазине было j пальто. когда некоторое количество пальто продали, то осталось z детских и d взрослых пальто. сколько пальто продали?',
  ...
  709,
  True),
 ('сварили u л варенья. в одну банку поместилось x л. сколько литров поместилось в другую банку, если осталось f л варенья?',
  ['x + f = x + f (л) – первая банка и остаток', 'u - x - f = u - x - f (л) – во второй банке'],
  'в другую банку поместилось u - x - f л варенья',
  'u - x - f',
  'л',
  710,
  True),
 ('в одном лесу растет w деревьев, в другом - на d деревьев меньше, чем в первом, а в третьем - на f деревьев больше, чем во втором. сколько деревьев растет в '
  'третьем лесу?',
  ...
  711,
  True),
 ('сережа решил z примеров на сложение и x примеров на вычитание. сколько примеров сереже было задано на дом, если осталось мальчику решить g примеров?',
 ...
 ('на планете n видов птиц, из них j птиц домашних. на сколько меньше домашних птиц, чем диких?',
  ...
  713,
  True),
 ('в 2 вазах по 3 розы. сколько роз в этих вазах?', ['2 · 3 = 6 (шт.) – роз'], 'в этих вазах 6 роз', '6', 'роз', 714, False),
 ('у одного кресла 4 ножки. сколько ножек у 4 кресел?', ['4 · 4 = 16 (шт.) – ножек'], 'у 4 кресел 16 ножек', '16', 'ножек', 715, False),
 ('на 3 полках по 2 кастрюли. сколько всего кастрюль на всех полках?',
  ...
  716,
  False),
 ('у жука 6 лапок. сколько лапок у 2 жуков?', ['6 · 2 = 12 (шт.) – лапок'], 'у 2 жуков 12 лапок', '12', 'лапок', 717, False),
 ('в 2 домах по 9 подъездов. сколько всего подъездов в обоих домах?',
  ...
  718,
  False),
 ('у паука 8 лапок. сколько лапок у 2 пауков?', ['8 · 2 = 16 (шт.) – лапок'], 'у 2 пауков 16 лапок', '16', 'лапок', 719, False),
 ('в 2 пеналах по 4 ручки. сколько всего ручек в пеналах?', ['2 · 4 = 8 (шт.) – ручек'], 'в пеналах 8 ручек', '8', 'ручек', 720, False),
 ('у сома 2 уса. сколько усов у 7 сомов?', ['2 · 7 = 14 (шт.) – усов'], 'у 7 сомов 14 усов', '14', 'усов', 721, False),
 ('в 5 клетках по 2 попугая. сколько попугаев в этих клетках?', ['5 · 2 = 10 (шт.) – попугаев'], 'в этих клетках 10 попугаев', '10', 'попугаев', 722, False),
 ('в сезоне 3 месяца. сколько месяцев в 2 сезонах?', ['3 · 2 = 6 (мес.) – месяцев'], 'в 2 сезонах 6 месяцев', '6', 'месяцев', 723, False),
 ('в 2 стручках по 6 горошин. сколько горошин в этих стручках?', ['2 · 6 = 12 (шт.) – горошин'], 'в этих стручках 12 горошин', '12', 'горошин', 724, False),
 ('сколько литров в 9 двухлитровых банках?', ['9 · 2 = 18 (л) – литров'], 'в 9 двухлитровых банках 18 л', '18', 'л', 725, False),
 ('на 7 кофтах по 2 пуговицы. сколько всего пуговиц на кофтах?', ['7 · 2 = 14 (шт.) – пуговиц'], 'на кофтах 14 пуговиц', '14', 'пуговиц', 726, False),
 ('в 2 пакетах по 5 кг овощей. сколько килограммов овощей в этих пакетах?',
  ...
  727,
  False),
 ('в 4 домах по 2 подъезда. сколько всего подъездов в этих домах?', ['4 · 2 = 8 (шт.) – подъездов'], 'в этих домах 8 подъездов', '8', 'подъездов', 728, False),
 ('в 2 рядах по 8 кустов смородины. сколько всего кустов смородины?',
  ...
  729,
  False),
 ('в 3 комнатах по 4 жильца. сколько жильцов в этих комнатах?', ['3 · 4 = 12 (чел.) – жильцов'], 'в этих комнатах 12 жильцов', '12', 'жильцов', 730, False),
 ('сколько литров в 4 трехлитровых банках?', ['4 · 3 = 12 (л) – литров'], 'в 4 трёхлитровых банках 12 л', '12', 'л', 731, False),
 ('одна тетрадь стоит 3 р. сколько стоят 7 таких тетрадей?',
  ['3 · 7 = 21 (руб.) – стоимость тетрадей'],
  '7 таких тетрадей стоят 21 рубль',
  '21',
  'рублей',
  732,
  False),
 ('одно платье стоит 10 р. сколько стоят 5 таких же платьев?',
  ...
  '5 таких платьев стоят 50 рублей',
  '50',
  'рублей',
  733,
  False),
 ('один килограмм яблок стоит 4 р. сколько стоят 5 кг яблок?',
  ...
  734,
  False),
 ('один килограмм слив стоит 6 р. сколько стоят 4 кг слив?', ['6 · 4 = 24 (руб.) – стоимость слив'], '4 кг слив стоят 24 рубля', '24', 'рубля', 735, False),
 ('булочка стоит 3 р. сколько нужно заплатить за 4 таких булочки?',
  ...
  736,
  False),
 ('у лены 8 монет по 5 р. сколько рублей у лены?', ['8 · 5 = 40 (руб.) – деньги у Лены'], 'у Лены 40 рублей', '40', 'рублей', 737, False),
 ('бабушка разложила на 6 тарелок по 5 булочек. сколько всего булочек разложила бабушка?',
  ['6 · 5 = 30 (шт.) – булочек'],
  'бабушка разложила 30 булочек',
  '30',
  'булочек',
  738,
  False),
 ...
 ('в коробке 5 карандашей. сколько карандашей в 9 таких коробках?',
  ...
  'в 9 таких коробках 45 карандашей',
  '45',
  'карандашей',
  740,
  False),
 ('в вагоне 9 купе по 4 места в каждом. сколько мест в вагоне?', ['9 · 4 = 36 (шт.) – мест'], 'в вагоне 36 мест', '36', 'мест', 741, False),
 ('дети посадили 8 рядов яблонь по 9 яблонь в ряду. сколько яблонь посадили дети?',
  ...
  742,
  False),
 ('в байдарке 4 гребца. сколько гребцов в 8 байдарках?', ['4 · 8 = 32 (чел.) – гребцов'], 'в 8 байдарках 32 гребца', '32', 'гребца', 743, False),
 ...
 ('цена одной тетради 2 р. сколько стоят 9 таких тетрадей?',
  ...
  '9 таких тетрадей стоят 18 рублей',
  '18',
  'рублей',
  747,
  False),
 ('в ряду сидит 3 мальчика, а девочек - в 2 раза больше. сколько сидит в ряду девочек?',
  ...
  748,
  False),
 ('у вадима 8 значков, а у марата - в 2 раза меньше. сколько значков у марата?', ['8 : 2 = 4 (шт.) – значков'], 'у Марата 4 значка', '4', 'значка', 749, False),
 ('в вазе 2 яблока, а груш - в 4 раза больше. сколько груш в вазе?', ['2 · 4 = 8 (шт.) – груш'], 'в вазе 8 груш', '8', 'груш', 750, False),
 ...
 ('у сосны хвоинки живут 2 года, а у ели - в 6 раз больше. сколько лет живут хвоинки ели?',
  ['2 · 6 = 12 (лет) – хвоинки ели'],
  'хвоинки ели живут 12 лет',
  '12',
  'лет',
  752,
  False),
 ('длина огорода 6 м, а ширина - в 3 раза меньше. какова ширина огорода?', ['6 : 3 = 2 (м) – ширина'], 'ширина огорода 2 м', '2', 'м', 753, False),
 ('ширина тесьмы 2 см, а ширина ленты - в 2 раза больше. какова ширина ленты?', ['2 · 2 = 4 (см) – ширина'], 'ширина ленты 4 см', '4', 'см', 754, False),
 ...
 ('у никиты было 6 белых голубей, а серых - в 2 раза больше. сколько серых голубей у никиты?',
  ...
  758,
  False),
 ('у переводчика было 14 словарей немецкого языка, а испанского - в 2 раза меньше. сколько у переводчика испанских словарей?',
  ...
  759,
  False),
 ('купили 4 м шерсти, а шелка - в 3 раза больше. сколько метров шелка купили?', ['4 · 3 = 12 (м) – шёлка'], 'купили 12 м шёлка', '12', 'м', 760, False),
 ('в саду росло 9 кустов черной смородины, а красной смородины - в 3 раза меньше. сколько кустов красной смородины росло в саду?',
  ...
  761,
  False),
 ('на зиму заготовили 9 банок вишневого компота, а клубничного - в 2 раза больше. сколько банок клубничного компота заготовили на зиму?',
 ...
 ('в коробке было 3 куска зеленого мела, а белого - в 5 раз больше. сколько кусков белого мела в коробке?',
  ...
  764,
  False),
 ('в одном классе 18 комнатных растений, а в другом классе - в 3 раза меньше. сколько комнатных растений в другом классе?',
 ...
 ('у школы росло 5 елей, а берез - в 4 раза больше. сколько берез росло около школы?',
  ...
  766,
  False),
 ('у юры 24 фломастера, а ручек - в 3 раза меньше. сколько ручек у юры?', ['24 : 3 = 8 (шт.) – ручек'], 'у Юры 8 ручек', '8', 'ручек', 767, False),
 ('на одной клумбе 15 цветов, а на другой - в 2 раза больше. сколько цветов на другой клумбе?',
  ...
  768,
  False),
 ('в первый день турист прошел 20 км, во второй день - в 2 раза меньше. сколько километров прошел турист во второй день?',
  ['20 : 2 = 10 (км) – во второй день'],
  'во второй день турист прошёл 10 км',
  '10',
  'км',
  769,
  False),
 ('в первый день аня прочитала 36 страниц, а во второй день - в 2 раза меньше. сколько страниц аня прочитала во второй день?',
  ['36 : 2 = 18 (шт.) – страниц'],
 ...
 ('в саду работали 8 девочек, а мальчиков - в 2 раза больше. сколько мальчиков работали в саду?',
  ...
  775,
  False),
 ('первоклассники нарисовали 18 рисунков, а второклассники - в 2 раза меньше. сколько рисунков нарисовали второклассники?',
  ['18 : 2 = 9 (шт.) – рисунков'],
 ...
 ('у оли 12 тетрадей в клетку, а общих тетрадей - в 3 раза меньше. сколько общих тетрадей у оли?',
  ...
  778,
  False),
 ('арбуз весит 12 кг, а дыня - в 2 раза меньше. сколько весит дыня?', ['12 : 2 = 6 (кг) – масса дыни'], 'дыня весит 6 кг', '6', 'кг', 779, False),
 ('в шахматном кружке занимаются 45 мальчиков, а девочек - в 5 раз меньше. сколько девочек занимаются в кружке?',
  ['45 : 5 = 9 (чел.) – девочек'],
  'в кружке занимаются 9 девочек',
  '9',
  'девочек',
  780,
  False),
 ('девочки собрали 9 кг лекарственных трав, а мальчики - в 5 раз больше. сколько килограммов трав собрали мальчики?',
  ...
  781,
  False),
 ('ива живет 100 лет, а дуб - в 4 раза больше. сколько лет живет дуб?', ['100 · 4 = 400 (лет) – живёт дуб'], 'дуб живёт 400 лет', '400', 'лет', 782, False),
 ('мухоловка пролетает в день 50 км, а почтовый голубь - в 8 раз больше. сколько километров в день пролетает почтовый голубь?',
 ...
 ('в 3 стакана опустили 6 кусков сахара. сколько кусков сахара в каждом стакане?',
  ...
  787,
  False),
 ('электрик ввинтил 10 лампочек по 5 в каждую люстру. сколько было люстр?', ['10 : 5 = 2 (шт.) – люстр'], 'было 2 люстры', '2', 'люстры', 788, False),
 ...
 ('12 человек сели в машины по 3 человека в каждую. сколько машин оказалось занято?',
  ...
  792,
  False),
 ('4 девочки поровну съели 8 груш. сколько груш съела каждая девочка?', ['8 : 4 = 2 (шт.) – груш'], 'каждая девочка съела 2 груши', '2', 'груши', 793, False),
 ('посадили 8 кустов клубники по 2 куста в каждом ряду. сколько получилось рядов?', ['8 : 2 = 4 (шт.) – рядов'], 'получилось 4 ряда', '4', 'ряда', 794, False),
 ('6 человек вымыли поровну 12 окон. сколько окон вымыл каждый?', ['12 : 6 = 2 (шт.) – окон'], 'каждый вымыл 2 окна', '2', 'окна', 795, False),
 ('в вазы поставили 15 георгинов по 3 в каждую вазу. сколько потребовалось ваз?', ['15 : 3 = 5 (шт.) – ваз'], 'потребовалось 5 ваз', '5', 'ваз', 796, False),
 ('мастер отремонтировал за 5 дней 10 телевизоров поровну в каждый день. сколько телевизоров он ремонтировал ежедневно?',
...
def _v40801_norm_task_key_for_match(value: str) -> str:
    key = _v40502_norm_task_key(value)
    key = re.sub(r'(?<![а-яa-z])р(?![а-яa-z])', 'p', key)
    key = re.sub(r'(?<![а-яa-z])п(?![а-яa-z])', 'n', key)
    return key

def _v40801_batch_701_800_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    key = _v40801_norm_task_key_for_match(original_text)
    spec = None
    for task_key, steps, final_answer, answer_number, answer_unit, excel_row, symbolic in _V40801_BATCH_701_800_SPECS:
        if key == _v40801_norm_task_key_for_match(task_key):
            spec = (steps, final_answer, answer_number, answer_unit, excel_row, symbolic)
            break
    if spec is None:
        return None
    steps, final_answer, answer_number, answer_unit, excel_row, symbolic = spec
    ...
    contract = str(out.get('visibleResultContract') or '').strip()
    if 'v408.01-batch-701-800' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v408.01-batch-701-800'
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v408.01-batch-701-800-exact-postprocess'
    return out
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v408.01-live-excel-numeric-regression',
