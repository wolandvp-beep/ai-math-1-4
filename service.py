...
APP_RELEASE = 'v402_10_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.10-live-excel-numeric-regression'
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V402.10: do not repeat a full answer predicate or a bare unit word after
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.10-apples-remaining-counted-unit',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-birds-remaining-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-march-days-remaining-dash-explanation',
        }
    if (
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.10-bus-remaining-people-exact',
        }
    if (
        'с начала марта прошло 7 дней' in compact
        and 'в марте 31 день' in compact
        ...
        return {
            ...
            'steps': ['31 - 7 = 24 (д.) – дней'],
            'final_answer': 'до конца марта осталось 24 дня',
            'contract': 'v402.10-march-days-remaining-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-tabletop-corner-cut-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-zebra-arrived-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-milk-glasses-taken-exact',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-kindergarten-bunnies-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.10-books-taken-full-answer',
        }
    return None
...
def _v40111_apply_exact_user_requested_regression_solution(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # V402.10: frontend audit displays userVisibleResultText directly.
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V402.10: repair accepted-but-awkward answer orders from batch 100-199.
...
def _v40208_sync_user_visible_result_text(out: dict[str, Any], original_text: str) -> bool:
    ...
    if 'v402.10-synced-visible-result' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v402.10-synced-visible-result'
    out['v40208UserVisibleResultSynced'] = True
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v402.10-user-visible-result-sync'
    return True
