...
APP_RELEASE = 'v412_live_excel_numeric_regression'
SOLVER_VERSION = 'v412-live-excel-numeric-regression'
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v412-live-excel-numeric-regression',
