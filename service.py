...
APP_RELEASE = 'v402_07_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.07-live-excel-numeric-regression'
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V402.07: do not repeat a full answer predicate or a bare unit word after
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V402.07: repair accepted-but-awkward answer orders from batch 100-199.
