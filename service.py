...
APP_RELEASE = 'v309.01_live_g3_math_information_visible_answers'
SOLVER_VERSION = 'v309.01-live-g3-math-information'
...
def _postprocess_deepseek_primary_payload(payload: dict, original_text: str) -> dict:
    # V309.01: DeepSeek is still called for live-audit evidence, but for the
