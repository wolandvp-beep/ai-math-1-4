...
APP_RELEASE = 'v306_live_g3_arithmetic_actions'
SOLVER_VERSION = 'v306-live-g3-arithmetic-actions'
...
def _v306_letter_payload(text: str) -> dict | None:
    ...
    steps = [f'Подставляем значение буквы: {expr_raw} = {expr_sub}', f'{expr_sub} = {answer}']
