...
APP_RELEASE = 'v412_02_live_excel_numeric_regression'
SOLVER_VERSION = 'v412.02-live-excel-numeric-regression'
...
# V412.02: exact post-API repair for Excel rows 1101-1200.  The live batch
...
async def _call_deepseek_primary(payload: str) -> dict | None:
    ...
    if not parsed:
        ...
        # V412.02: the first DeepSeek call restores legacy_core.DEEPSEEK_API_KEY in
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v412.02-live-excel-numeric-regression',
