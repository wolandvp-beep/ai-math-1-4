...
APP_RELEASE = 'v412_01_live_excel_numeric_regression'
SOLVER_VERSION = 'v412.01-live-excel-numeric-regression'
...
# V412.01: exact post-API repair for Excel rows 1101-1200.  The live batch
...
def _v41201_batch_1101_1200_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    contract = str(out.get('visibleResultContract') or '').strip()
    if 'v412.01-batch-1101-1200' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v412.01-batch-1101-1200'
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v412.01-batch-1101-1200-exact-postprocess'
    return out
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v412.01-live-excel-numeric-regression',
