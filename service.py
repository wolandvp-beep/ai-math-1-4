...
APP_RELEASE = 'v313.1_live_g4_geometry'
SOLVER_VERSION = 'v313.1-live-g4-geometry'
...
def _v313_payload(original_text: str, *, steps: list[str], final_answer: str, answer_number: int | str = '', answer_unit: str = '') -> dict:
    ...
    return {
        ...
        'visibleResultContract': 'v313.1-g4-geometry-canonical',
...
def _v313_case_specs() -> dict[str, dict[str, Any]]:
    ...
    if len(specs) != 100:
        raise AssertionError(f'V313.1 service specs expected 100, got {len(specs)}')
...
def canonicalize_v313_geometry_response(original_text: str, payload: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    merged['visibleResultContract'] = 'v313.1-g4-geometry-canonical'
