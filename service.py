...
APP_RELEASE = 'v411_04_live_excel_numeric_regression'
SOLVER_VERSION = 'v411.04-live-excel-numeric-regression'
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v411.04-live-excel-numeric-regression',
