...
APP_RELEASE = 'v402_02_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.02-live-excel-numeric-regression'
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.02-baobab-thousand-years-numeric-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-student-remaining-tasks-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-currant-cups-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-girls-part-whole-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-linden-trees-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-voiceless-consonants-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-ill-people-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.02-arrived-cars-full-answer',
        }
    return None
...
def _v40201_special_non_numeric_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    if _v40201_is_odd_mushroom_task(original_text):
        ...
        out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v402.02-special-non-numeric-repair'
        return out
    return None
