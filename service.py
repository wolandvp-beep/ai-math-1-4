...
APP_RELEASE = 'v411_03_live_excel_numeric_regression'
SOLVER_VERSION = 'v411.03-live-excel-numeric-regression'
...
def _v41102_batch_1001_1100_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    contract = str(out.get('visibleResultContract') or '').strip()
    if 'v411.03-batch-1001-1100' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v411.03-batch-1001-1100'
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v411.03-batch-1001-1100-exact-postprocess'
    return out
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v411.03-live-excel-numeric-regression',
