...
APP_RELEASE = 'v311.05_live_g4_arithmetic_equation_order_replay_fix'
SOLVER_VERSION = 'v311.05-live-g4-arithmetic-equation-order-replay-fix'
...
def _v311_payload(original_text: str, *, source: str, steps: list[str], final_answer: str, answer_number: str = '', answer_unit: str = '') -> dict:
    answer = str(final_answer or '').strip().rstrip('.')
    result = _v311_format_visible_result(steps, answer)
    return {
        'result': result,
        'source': source,
        'validated': True,
