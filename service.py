...
APP_RELEASE = 'v403_06_live_excel_numeric_regression'
SOLVER_VERSION = 'v403.06-live-excel-nonnumeric-answer-only-no-placeholder'
...
def prevalidate_explanation_request(user_text: str) -> dict | None:
    ...
    # V403.06: several Excel rows with «несколько» are complete inverse
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V403.06: do not repeat a full answer predicate or a bare unit word after
...
def _v40111_apply_exact_user_requested_regression_solution(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # V403.06: frontend audit displays userVisibleResultText directly.
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V403.06: repair accepted-but-awkward answer orders from batch 100-199.
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    # V403.06: for assignment-style rows that are not solved by arithmetic,
