...
APP_RELEASE = 'v406_01_live_excel_numeric_regression'
SOLVER_VERSION = 'v406.01-live-excel-numeric-regression'
...
def _v40402_exact_batch_300_solution(original_text: str) -> dict[str, Any] | None:
    """Exact visible-solution fixes for V404 batch (Excel rows 501-600).
