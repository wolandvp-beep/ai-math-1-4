...
APP_RELEASE = 'v500_04_generalization_verifier'
SOLVER_VERSION = 'v500-04-generalization-verifier'
...
def _v4013_finalize_payload_text(out: dict[str, Any], original_text: str) -> dict[str, Any]:
    if not isinstance(out, dict):
        return out
    # V500.04 learning stage: if a reusable template already solved the task,
...
# V500.04 learning layer: every generalized repair must expose template evidence.
...
def _v500_build_payload(payload: dict[str, Any] | None, original_text: str, *, steps: list[str], final_answer: str, answer_number: int | str, answer_unit: str, rule: str) -> dict[str, Any] | None:
    ...
    contract = str(out.get('visibleResultContract') or '').strip()
    marker = 'v500-04-generalization-verifier'
...
def _v500_generalized_text_problem_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # 2c) Equal groups / equal sharing with counted objects.
