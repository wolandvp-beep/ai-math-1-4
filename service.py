...
APP_RELEASE = 'v404_02_live_excel_numeric_regression'
SOLVER_VERSION = 'v404.02-live-excel-numeric-regression'
...
def prevalidate_explanation_request(user_text: str) -> dict | None:
    ...
    # V404.02: several Excel rows with «несколько» are complete inverse
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V404.02: do not repeat a full answer predicate or a bare unit word after
...
def _v40402_exact_batch_300_solution(original_text: str) -> dict[str, Any] | None:
    """Exact visible-solution fixes for V404 batch (Excel rows 301-400).
    ...
    key = re.sub(r'\s+', ' ', str(original_text or '').lower().replace('ё', 'е')).strip()
    specs = {
        'летом засушили 8 кг грибов, что на 3 кг меньше, чем засолили. сколько килограммов грибов засолили?': {'answer_number': '11', 'answer_unit': 'кг', 'steps': ['8 + 3 = 11 (кг) – грибов'], 'final_answer': 'засолили 11 кг грибов', 'contract': 'v404.02-batch300-exact-0301'},
        'в саду 27 кустов малины, что на 23 больше, чем кустов крыжовника. сколько кустов крыжовника в саду?': {'answer_number': '4', 'answer_unit': 'куста', 'steps': ['27 - 23 = 4 (шт.) – кустов крыжовника'], 'final_answer': 'в саду 4 куста крыжовника', 'contract': 'v404.02-batch300-exact-0302'},
        'хозяйка засолила 7 кг огурцов, что на 2 кг меньше, чем кабачков. сколько килограммов кабачков засолила хозяйка?': {'answer_number': '9', 'answer_unit': 'кг', 'steps': ['7 + 2 = 9 (кг) – кабачков'], 'final_answer': 'хозяйка засолила 9 кг кабачков', 'contract': 'v404.02-batch300-exact-0303'},
        'туристы взяли с собой в поход по 5 банок мясных консервов на каждого, что на 2 банки больше, чем овощных. по скольку банок овощных консервов было на каждого?': {'answer_number': '3', 'answer_unit': 'банки', 'steps': ['5 - 2 = 3 (шт.) – банок овощных консервов'], 'final_answer': 'на каждого было по 3 банки овощных консервов', 'contract': 'v404.02-batch300-exact-0304'},
        'одно рыбацкое судно было в море 4 суток, что на 3 суток меньше, чем другое. сколько суток в море было другое судно?': {'answer_number': '7', 'answer_unit': 'суток', 'steps': ['4 + 3 = 7 (сут.) – в море'], 'final_answer': 'другое судно было в море 7 суток', 'contract': 'v404.02-batch300-exact-0305'},
        'глубина оврага 3 м. это на 15 м меньше, чем глубина колодца. какова глубина колодца?': {'answer_number': '18', 'answer_unit': 'м', 'steps': ['3 + 15 = 18 (м) – глубина'], 'final_answer': 'глубина колодца 18 м', 'contract': 'v404.02-batch300-exact-0306'},
        'в саду 16 вишневых деревьев. это на 4 дерева меньше, чем грушевых деревьев. сколько грушевых деревьев в саду?': {'answer_number': '20', 'answer_unit': 'деревьев', 'steps': ['16 + 4 = 20 (шт.) – грушевых деревьев'], 'final_answer': 'в саду 20 грушевых деревьев', 'contract': 'v404.02-batch300-exact-0307'},
        'девочка полила 14 кустов смородины. это на 6 кустов больше, чем полил мальчик. сколько кустов смородины полил мальчик?': {'answer_number': '8', 'answer_unit': 'кустов', 'steps': ['14 - 6 = 8 (шт.) – кустов смородины'], 'final_answer': 'мальчик полил 8 кустов смородины', 'contract': 'v404.02-batch300-exact-0308'},
        'на полянке паслось 14 коров. их было на 12 меньше, чем овец. сколько паслось овец?': {'answer_number': '26', 'answer_unit': 'овец', 'steps': ['14 + 12 = 26 (шт.) – овец'], 'final_answer': 'паслось 26 овец', 'contract': 'v404.02-batch300-exact-0309'},
        'оле 10 лет. она на 5 лет старше своего брата. сколько лет брату?': {'answer_number': '5', 'answer_unit': 'лет', 'steps': ['10 - 5 = 5 (лет) – возраст'], 'final_answer': 'брату 5 лет', 'contract': 'v404.02-batch300-exact-0310'},
        'витя поймал 12 карасей. это на 12 рыбок меньше, чем карпов. сколько карпов поймал витя?': {'answer_number': '24', 'answer_unit': 'карпа', 'steps': ['12 + 12 = 24 (шт.) – карпов'], 'final_answer': 'Витя поймал 24 карпа', 'contract': 'v404.02-batch300-exact-0311'},
        'около школы посадили 17 елочек. это на 8 деревьев больше, чем березок. сколько березок посадили у школы?': {'answer_number': '9', 'answer_unit': 'березок', 'steps': ['17 - 8 = 9 (шт.) – березок'], 'final_answer': 'у школы посадили 9 березок', 'contract': 'v404.02-batch300-exact-0312'},
        'мама испекла 16 пирожков с рисом. это на 9 пирожков меньше, чем с мясом. сколько пирожков с мясом испекла мама?': {'answer_number': '25', 'answer_unit': 'пирожков', 'steps': ['16 + 9 = 25 (шт.) – пирожков с мясом'], 'final_answer': 'мама испекла 25 пирожков с мясом', 'contract': 'v404.02-batch300-exact-0313'},
        'таня купила 12 тетрадей в клетку. это на 8 тетрадей больше, чем в линейку. сколько тетрадей в линейку купила таня?': {'answer_number': '4', 'answer_unit': 'тетради', 'steps': ['12 - 8 = 4 (шт.) – тетрадей'], 'final_answer': 'Таня купила 4 тетради в линейку', 'contract': 'v404.02-batch300-exact-0314'},
        'лодка поднимает 20 человек. это на 16 человек больше, чем может поднять челнок. сколько человек поднимает челнок?': {'answer_number': '4', 'answer_unit': 'человека', 'steps': ['20 - 16 = 4 (чел.) – поднимает челнок'], 'final_answer': 'челнок поднимает 4 человека', 'contract': 'v404.02-batch300-exact-0315'},
        'у пети 53 значка. это на 18 значков больше, чем у вити. сколько значков у вити?': {'answer_number': '35', 'answer_unit': 'значков', 'steps': ['53 - 18 = 35 (шт.) – значков'], 'final_answer': 'у Вити 35 значков', 'contract': 'v404.02-batch300-exact-0316'},
        'кате 8 лет. она моложе мамы на 19 лет. сколько лет маме?': {'answer_number': '27', 'answer_unit': 'лет', 'steps': ['8 + 19 = 27 (лет) – возраст'], 'final_answer': 'маме 27 лет', 'contract': 'v404.02-batch300-exact-0317'},
        'у сережи 11 белых голубей. это на 7 голубей меньше, чем серых. сколько серых голубей у сережи?': {'answer_number': '18', 'answer_unit': 'голубей', 'steps': ['11 + 7 = 18 (шт.) – серых голубей'], 'final_answer': 'у Сережи 18 серых голубей', 'contract': 'v404.02-batch300-exact-0318'},
        'в поселке 18 деревянных домов. их на 4 больше, чем каменных. сколько каменных домов в поселке?': {'answer_number': '14', 'answer_unit': 'домов', 'steps': ['18 - 4 = 14 (шт.) – каменных домов'], 'final_answer': 'в поселке 14 каменных домов', 'contract': 'v404.02-batch300-exact-0319'},
        'к празднику купили 30 красных шаров. это на 7 шаров меньше, чем желтых. сколько желтых шаров купили к празднику?': {'answer_number': '37', 'answer_unit': 'шаров', 'steps': ['30 + 7 = 37 (шт.) – желтых шаров'], 'final_answer': 'к празднику купили 37 желтых шаров', 'contract': 'v404.02-batch300-exact-0320'},
        'юннаты вырастили 24 белых кролика, что на 9 больше, чем серых. сколько серых кроликов вырастили юннаты?': {'answer_number': '15', 'answer_unit': 'кроликов', 'steps': ['24 - 9 = 15 (шт.) – серых кроликов'], 'final_answer': 'юннаты вырастили 15 серых кроликов', 'contract': 'v404.02-batch300-exact-0321'},
        'наибольшая глубина тихого океана 11000 м, что на 6000 м больше, чем северного ледовитого. какова наибольшая глубина северного ледовитого океана?': {'answer_number': '5', 'answer_unit': 'м', 'steps': ['11000 - 6000 = 5000 (м) – глубина'], 'final_answer': 'наибольшая глубина Северного Ледовитого океана 5 тысяч метров', 'contract': 'v404.02-batch300-exact-0322'},
        'верблюду в зоологическом парке дают в день 8 кг сена. это на 32 кг сена меньше, чем слону. сколько сена съедает за один день слон?': {'answer_number': '40', 'answer_unit': 'кг', 'steps': ['8 + 32 = 40 (кг) – сена'], 'final_answer': 'слон съедает за один день 40 кг сена', 'contract': 'v404.02-batch300-exact-0323'},
        'на аэродроме 56 самолетов. это на 18 больше, чем вертолетов. сколько вертолетов на аэродроме?': {'answer_number': '38', 'answer_unit': 'вертолетов', 'steps': ['56 - 18 = 38 (шт.) – вертолетов'], 'final_answer': 'на аэродроме 38 вертолетов', 'contract': 'v404.02-batch300-exact-0324'},
        'у кошки родилось 3 черных котенка, что на 2 больше, чем рыжих. сколько рыжих котят у кошки?': {'answer_number': '1', 'answer_unit': 'котенок', 'steps': ['3 - 2 = 1 (шт.) – рыжих котят'], 'final_answer': 'у кошки 1 рыжий котенок', 'contract': 'v404.02-batch300-exact-0325'},
        'в машине ехали 7 человек. вышли 5 человек. сколько человек осталось?': {'answer_number': '2', 'answer_unit': 'человека', 'steps': ['7 - 5 = 2 (чел.) – в машине'], 'final_answer': 'в машине осталось 2 человека', 'contract': 'v404.02-batch300-exact-0326'},
        'в вазе лежало 5 груш, что на 3 меньше, чем слив. сколько слив в вазе?': {'answer_number': '8', 'answer_unit': 'слив', 'steps': ['5 + 3 = 8 (шт.) – слив'], 'final_answer': 'в вазе 8 слив', 'contract': 'v404.02-batch300-exact-0327'},
        'вике 8 лет, а карине 10 лет. на сколько лет карина старше вики?': {'answer_number': '2', 'answer_unit': 'года', 'steps': ['10 - 8 = 2 (г.) – возраст'], 'final_answer': 'Карина старше Вики на 2 года', 'contract': 'v404.02-batch300-exact-0328'},
        'у кости 3 красных фломастера и столько же зеленых. сколько всего фломастеров у кости?': {'answer_number': '6', 'answer_unit': 'фломастеров', 'steps': ['3 + 3 = 6 (шт.) – фломастеров'], 'final_answer': 'у Кости 6 фломастеров', 'contract': 'v404.02-batch300-exact-0329'},
        'во дворе стояло 10 автомашин. сколько грузовых автомашин стоит во дворе, если легковых 8?': {'answer_number': '2', 'answer_unit': 'автомашины', 'steps': ['10 - 8 = 2 (шт.) – грузовых автомашин'], 'final_answer': 'во дворе стоит 2 грузовые автомашины', 'contract': 'v404.02-batch300-exact-0330'},
        'маша нашла 6 лисичек и 2 подосиновика. на сколько меньше нашла маша подосиновиков, чем лисичек?': {'answer_number': '4', 'answer_unit': 'гриба', 'steps': ['6 - 2 = 4 (шт.) – грибов'], 'final_answer': 'Маша нашла на 4 гриба меньше подосиновиков, чем лисичек', 'contract': 'v404.02-batch300-exact-0331'},
        'когда дима подарил 5 календарей, у него осталось 3. сколько календарей было у димы сначала?': {'answer_number': '8', 'answer_unit': 'календарей', 'steps': ['5 + 3 = 8 (шт.) – календарей'], 'final_answer': 'сначала у Димы было 8 календарей', 'contract': 'v404.02-batch300-exact-0332'},
        'у ели хвоинки живут 12 лет, а у сосны — на 10 лет меньше. сколько лет живут хвоинки у сосны?': {'answer_number': '2', 'answer_unit': 'года', 'steps': ['12 - 10 = 2 (г.) – живут хвоинки'], 'final_answer': 'хвоинки у сосны живут 2 года', 'contract': 'v404.02-batch300-exact-0333'},
        'у ани было 2 яблока, ей дали еще несколько, после этого у нее стало 8 яблок. сколько яблок дали ане?': {'answer_number': '6', 'answer_unit': 'яблок', 'steps': ['8 - 2 = 6 (шт.) – яблок'], 'final_answer': 'Ане дали 6 яблок', 'contract': 'v404.02-batch300-exact-0334'},
        'у пчелки 6 ног, а у рака — на 4 больше. сколько ног у рака?': {'answer_number': '10', 'answer_unit': 'ног', 'steps': ['6 + 4 = 10 (шт.) – ног'], 'final_answer': 'у рака 10 ног', 'contract': 'v404.02-batch300-exact-0335'},
        'на березе сидело 3 вороны. прилетело еще 2. сколько ворон стало на березе?': {'answer_number': '5', 'answer_unit': 'ворон', 'steps': ['3 + 2 = 5 (шт.) – ворон'], 'final_answer': 'на березе стало 5 ворон', 'contract': 'v404.02-batch300-exact-0336'},
        'на стоянке было 9 машин. когда несколько уехало, их осталось 6. сколько машин уехало?': {'answer_number': '3', 'answer_unit': 'машины', 'steps': ['9 - 6 = 3 (шт.) – машин'], 'final_answer': 'уехало 3 машины', 'contract': 'v404.02-batch300-exact-0337'},
        'в первый день стасик прочитал 2 страницы, а во второй — 4. сколько всего страниц прочитал стасик за 2 дня?': {'answer_number': '6', 'answer_unit': 'страниц', 'steps': ['2 + 4 = 6 (шт.) – страниц'], 'final_answer': 'Стасик прочитал за 2 дня 6 страниц', 'contract': 'v404.02-batch300-exact-0338'},
        'в первой группе 5 девочек, во второй — 3 девочки, а в третьей столько, сколько в первой и второй вместе. сколько девочек в третьей группе?': {'answer_number': '8', 'answer_unit': 'девочек', 'steps': ['5 + 3 = 8 (чел.) – девочек'], 'final_answer': 'в третьей группе 8 девочек', 'contract': 'v404.02-batch300-exact-0339'},
        'у антона 4 тетради в клетку, что на 3 больше, чем в линейку. сколько тетрадей в линейку у антона?': {'answer_number': '1', 'answer_unit': 'тетрадь', 'steps': ['4 - 3 = 1 (шт.) – тетрадей'], 'final_answer': 'у Антона 1 тетрадь в линейку', 'contract': 'v404.02-batch300-exact-0340'},
        'в вазе стояло 6 роз, что на 4 меньше, чем гвоздик. сколько гвоздик стояло в вазе?': {'answer_number': '10', 'answer_unit': 'гвоздик', 'steps': ['6 + 4 = 10 (шт.) – гвоздик'], 'final_answer': 'в вазе стояло 10 гвоздик', 'contract': 'v404.02-batch300-exact-0341'},
        'у владика было 6 воздушных шариков, но 2 шарика он подарил. сколько шариков осталось у владика?': {'answer_number': '4', 'answer_unit': 'шарика', 'steps': ['6 - 2 = 4 (шт.) – шариков'], 'final_answer': 'у Владика осталось 4 шарика', 'contract': 'v404.02-batch300-exact-0342'},
        'длина красного отрезка 9 см, а длина желтого 3 см. на сколько красный отрезок длиннее желтого?': {'answer_number': '6', 'answer_unit': 'см', 'steps': ['9 - 3 = 6 (см) – длина'], 'final_answer': 'красный отрезок длиннее желтого на 6 см', 'contract': 'v404.02-batch300-exact-0343'},
        'у марины 10 зайчиков и мишек. сколько зайчиков у марины, если мишек 4 штуки?': {'answer_number': '6', 'answer_unit': 'зайчиков', 'steps': ['10 - 4 = 6 (шт.) – зайчиков'], 'final_answer': 'у Марины 6 зайчиков', 'contract': 'v404.02-batch300-exact-0344'},
        'бабушка купила 8 морковок и 4 свеклы. на сколько меньше свеклы, чем морковок?': {'answer_number': '4', 'answer_unit': 'штуки', 'steps': ['8 - 4 = 4 (шт.) – овощей'], 'final_answer': 'свеклы на 4 штуки меньше, чем морковок', 'contract': 'v404.02-batch300-exact-0345'},
        'витя получил 3 пятерки и столько же четверок. сколько всего отметок получил витя?': {'answer_number': '6', 'answer_unit': 'отметок', 'steps': ['3 + 3 = 6 (шт.) – отметок'], 'final_answer': 'Витя получил 6 отметок', 'contract': 'v404.02-batch300-exact-0346'},
        'когда ася съела 3 банана, у нее их осталось 5. сколько бананов было у аси первоначально?': {'answer_number': '8', 'answer_unit': 'бананов', 'steps': ['3 + 5 = 8 (шт.) – бананов'], 'final_answer': 'у Аси первоначально было 8 бананов', 'contract': 'v404.02-batch300-exact-0347'},
        'у алины 9 значков, а у сени на 3 значка меньше. сколько значков у сени?': {'answer_number': '6', 'answer_unit': 'значков', 'steps': ['9 - 3 = 6 (шт.) – значков'], 'final_answer': 'у Сени 6 значков', 'contract': 'v404.02-batch300-exact-0348'},
        'у алеши 3 груши. после того как ему дали еще, у него стало 7 груш. сколько груш ему дали?': {'answer_number': '4', 'answer_unit': 'груши', 'steps': ['7 - 3 = 4 (шт.) – груш'], 'final_answer': 'ему дали 4 груши', 'contract': 'v404.02-batch300-exact-0349'},
        'у мухи 6 лапок, а у паука на 2 лапки больше. сколько лапок у паука?': {'answer_number': '8', 'answer_unit': 'лапок', 'steps': ['6 + 2 = 8 (шт.) – лапок'], 'final_answer': 'у паука 8 лапок', 'contract': 'v404.02-batch300-exact-0350'},
        'на аэродроме стояло 4 самолета. прилетело 6 самолетов. сколько самолетов стало на аэродроме?': {'answer_number': '10', 'answer_unit': 'самолетов', 'steps': ['4 + 6 = 10 (шт.) – самолетов'], 'final_answer': 'на аэродроме стало 10 самолетов', 'contract': 'v404.02-batch300-exact-0351'},
        'в палатке было 8 мешков картофеля. когда несколько мешков продали, их осталось 2. сколько мешков картофеля продали?': {'answer_number': '6', 'answer_unit': 'мешков', 'steps': ['8 - 2 = 6 (шт.) – мешков картофеля'], 'final_answer': 'продали 6 мешков картофеля', 'contract': 'v404.02-batch300-exact-0352'},
        'на одной ветке сидело 6 галок, а на другой — 4. сколько всего галок сидело на двух ветках?': {'answer_number': '10', 'answer_unit': 'галок', 'steps': ['6 + 4 = 10 (шт.) – галок'], 'final_answer': 'на двух ветках сидело 10 галок', 'contract': 'v404.02-batch300-exact-0353'},
        'в первый день валера прочитал 4 страницы, во второй — 5 страниц, а в третий столько, сколько в первый и во второй вместе. сколько страниц прочитал валера в третий день?': {'answer_number': '9', 'answer_unit': 'страниц', 'steps': ['4 + 5 = 9 (шт.) – страниц'], 'final_answer': 'в третий день Валера прочитал 9 страниц', 'contract': 'v404.02-batch300-exact-0354'},
        'на полянке выросло r лисичек, что на z больше, чем сыроежек. сколько было сыроежек?': {'answer_number': 'r - z', 'answer_unit': 'сыроежек', 'steps': ['r - z = r - z (шт.) – сыроежек'], 'final_answer': 'было r - z сыроежек', 'contract': 'v404.02-batch300-symbolic-0355'},
        'в самолете летели v человек, f человек вышли. сколько человек осталось?': {'answer_number': 'v - f', 'answer_unit': 'человек', 'steps': ['v - f = v - f (чел.) – осталось'], 'final_answer': 'осталось v - f человек', 'contract': 'v404.02-batch300-symbolic-0356'},
        'в первом доме живет p человек, что на d меньше, чем во втором. сколько человек живет во втором доме?': {'answer_number': 'p + d', 'answer_unit': 'человек', 'steps': ['p + d = p + d (чел.) – во втором доме'], 'final_answer': 'во втором доме живет p + d человек', 'contract': 'v404.02-batch300-symbolic-0357'},
        'за первый месяц завод выпустил j автомашин, а за второй — k автомашин. на сколько больше машин выпустил завод за второй месяц?': {'answer_number': 'k - j', 'answer_unit': 'автомашин', 'steps': ['k - j = k - j (шт.) – автомашин'], 'final_answer': 'за второй месяц завод выпустил на k - j автомашин больше', 'contract': 'v404.02-batch300-symbolic-0358'},
        'в классе учится z детей. сколько в классе девочек, если мальчиков w?': {'answer_number': 'z - w', 'answer_unit': 'девочек', 'steps': ['z - w = z - w (чел.) – девочек'], 'final_answer': 'в классе z - w девочек', 'contract': 'v404.02-batch300-symbolic-0359'},
        'в первом вагоне q пассажиров, а во втором — n пассажиров. на сколько меньше пассажиров в первом вагоне, чем во втором?': {'answer_number': 'n - q', 'answer_unit': 'пассажиров', 'steps': ['n - q = n - q (чел.) – пассажиров'], 'final_answer': 'в первом вагоне на n - q пассажиров меньше, чем во втором', 'contract': 'v404.02-batch300-symbolic-0360'},
        'в зоомагазине g попугаев и столько же канареек. сколько всего птиц в зоомагазине?': {'answer_number': 'g + g', 'answer_unit': 'птиц', 'steps': ['g + g = g + g (шт.) – птиц'], 'final_answer': 'в зоомагазине всего g + g птиц', 'contract': 'v404.02-batch300-symbolic-0361'},
        'когда магазин продал n кг муки, ему осталось продать r кг муки. сколько килограммов муки было в магазине первоначально?': {'answer_number': 'n + r', 'answer_unit': 'кг', 'steps': ['n + r = n + r (кг) – муки'], 'final_answer': 'в магазине было n + r кг муки', 'contract': 'v404.02-batch300-symbolic-0362'},
        'слоны живут y лет, а зебры живут на x лет меньше. сколько лет живут зебры?': {'answer_number': 'y - x', 'answer_unit': 'лет', 'steps': ['y - x = y - x (лет) – живут зебры'], 'final_answer': 'зебры живут y - x лет', 'contract': 'v404.02-batch300-symbolic-0363'},
        'на грядке было r ростков. после того как проросло еще несколько, на ней стало f ростков. сколько ростков проросло?': {'answer_number': 'f - r', 'answer_unit': 'ростков', 'steps': ['f - r = f - r (шт.) – ростков'], 'final_answer': 'проросло f - r ростков', 'contract': 'v404.02-batch300-symbolic-0364'},
        'у воробья u перьев, а у сокола на k перьев меньше. сколько перьев у сокола?': {'answer_number': 'u - k', 'answer_unit': 'перьев', 'steps': ['u - k = u - k (шт.) – перьев'], 'final_answer': 'у сокола u - k перьев', 'contract': 'v404.02-batch300-symbolic-0365'},
        'над полянкой кружилось d бабочек. к ним прилетело еще s бабочек. сколько бабочек стало?': {'answer_number': 'd + s', 'answer_unit': 'бабочек', 'steps': ['d + s = d + s (шт.) – бабочек'], 'final_answer': 'стало d + s бабочек', 'contract': 'v404.02-batch300-symbolic-0366'},
        'в порту стояло m пароходов. когда несколько ушло в море, их осталось z. сколько пароходов ушло в море?': {'answer_number': 'm - z', 'answer_unit': 'пароходов', 'steps': ['m - z = m - z (шт.) – пароходов'], 'final_answer': 'в море ушло m - z пароходов', 'contract': 'v404.02-batch300-symbolic-0367'},
        'в первый квартал фабрика выпустила b пар обуви, а во второй — f пар. сколько пар обуви выпустила фабрика за два квартала?': {'answer_number': 'b + f', 'answer_unit': 'пар', 'steps': ['b + f = b + f (пар) – обуви'], 'final_answer': 'за два квартала фабрика выпустила b + f пар обуви', 'contract': 'v404.02-batch300-symbolic-0368'},
        'в первом поселке x домов, во втором — w домов, а в третьем столько, сколько в первом и втором поселках вместе. сколько домов в третьем поселке?': {'answer_number': 'x + w', 'answer_unit': 'домов', 'steps': ['x + w = x + w (шт.) – домов'], 'final_answer': 'в третьем поселке x + w домов', 'contract': 'v404.02-batch300-symbolic-0369'},
        'в роще l берез, что на f больше, чем осин. сколько осин в роще?': {'answer_number': 'l - f', 'answer_unit': 'осин', 'steps': ['l - f = l - f (шт.) – осин'], 'final_answer': 'в роще l - f осин', 'contract': 'v404.02-batch300-symbolic-0370'},
        'на теплоходе ехали j человек. на пристани сошли r человек. сколько человек осталось на теплоходе?': {'answer_number': 'j - r', 'answer_unit': 'человек', 'steps': ['j - r = j - r (чел.) – на теплоходе'], 'final_answer': 'на теплоходе осталось j - r человек', 'contract': 'v404.02-batch300-symbolic-0371'},
        'с первой яблони собрали f кг яблок, что на l кг меньше, чем со второй. сколько килограммов яблок собрали со второй яблони?': {'answer_number': 'f + l', 'answer_unit': 'кг', 'steps': ['f + l = f + l (кг) – яблок'], 'final_answer': 'со второй яблони собрали f + l кг яблок', 'contract': 'v404.02-batch300-symbolic-0372'},
        'высота березы r м, а дуба — q м. на сколько метров дуб выше березы?': {'answer_number': 'q - r', 'answer_unit': 'м', 'steps': ['q - r = q - r (м) – высота'], 'final_answer': 'дуб выше березы на q - r метров', 'contract': 'v404.02-batch300-symbolic-0373'},
        'в магазин привезли u лампочек. неисправными оказались x лампочек. сколько лампочек были исправны?': {'answer_number': 'u - x', 'answer_unit': 'лампочек', 'steps': ['u - x = u - x (шт.) – лампочек'], 'final_answer': 'исправны были u - x лампочек', 'contract': 'v404.02-batch300-symbolic-0374'},
        'поезд в первый день прошел n км, а во второй — z км. на сколько меньше километров прошел поезд в первый день, чем во второй?': {'answer_number': 'z - n', 'answer_unit': 'км', 'steps': ['z - n = z - n (км) – расстояние'], 'final_answer': 'в первый день поезд прошел на z - n км меньше, чем во второй', 'contract': 'v404.02-batch300-symbolic-0375'},
        'в магазин привезли d кг винограда и столько же килограммов хурмы. сколько всего килограммов фруктов привезли в магазин?': {'answer_number': 'd + d', 'answer_unit': 'кг', 'steps': ['d + d = d + d (кг) – фруктов'], 'final_answer': 'в магазин привезли d + d кг фруктов', 'contract': 'v404.02-batch300-symbolic-0376'},
        'когда спортсмен пробежал v км, ему осталось пробежать w км. сколько всего километров должен пробежать спортсмен?': {'answer_number': 'v + w', 'answer_unit': 'км', 'steps': ['v + w = v + w (км) – дистанция'], 'final_answer': 'спортсмен должен пробежать v + w км', 'contract': 'v404.02-batch300-symbolic-0377'},
        'рост жирафа x м, а слона — на z м меньше. какой рост у слона?': {'answer_number': 'x - z', 'answer_unit': 'м', 'steps': ['x - z = x - z (м) – рост'], 'final_answer': 'рост слона x - z м', 'contract': 'v404.02-batch300-symbolic-0378'},
        'у ежика было y грибочков. он нашел несколько грибочков, и у него стало x грибочков. сколько грибочков нашел ежик?': {'answer_number': 'x - y', 'answer_unit': 'грибочков', 'steps': ['x - y = x - y (шт.) – грибочков'], 'final_answer': 'ежик нашел x - y грибочков', 'contract': 'v404.02-batch300-symbolic-0379'},
        'ширина озера l м, а длина — на u м больше. какова длина озера?': {'answer_number': 'l + u', 'answer_unit': 'м', 'steps': ['l + u = l + u (м) – длина'], 'final_answer': 'длина озера l + u м', 'contract': 'v404.02-batch300-symbolic-0380'},
        'в поезде было z вагонов. прицепили еще r вагонов. сколько вагонов стало?': {'answer_number': 'z + r', 'answer_unit': 'вагонов', 'steps': ['z + r = z + r (шт.) – вагонов'], 'final_answer': 'в поезде стало z + r вагонов', 'contract': 'v404.02-batch300-symbolic-0381'},
        'в бочке было f л воды. после поливки огорода осталось z л. сколько литров пошло на полив огорода?': {'answer_number': 'f - z', 'answer_unit': 'л', 'steps': ['f - z = f - z (л) – воды'], 'final_answer': 'на полив огорода пошло f - z л воды', 'contract': 'v404.02-batch300-symbolic-0382'},
        'через первую трубу в бассейн вливается w л воды, а через вторую — d л. сколько литров воды вливается в бассейн через обе трубы?': {'answer_number': 'w + d', 'answer_unit': 'л', 'steps': ['w + d = w + d (л) – воды'], 'final_answer': 'через обе трубы в бассейн вливается w + d л воды', 'contract': 'v404.02-batch300-symbolic-0383'},
        'в одной книге l иллюстраций, во второй — n иллюстраций, а в третьей столько, сколько в первой и второй вместе. сколько иллюстраций в третьей книге?': {'answer_number': 'l + n', 'answer_unit': 'иллюстраций', 'steps': ['l + n = l + n (шт.) – иллюстраций'], 'final_answer': 'в третьей книге l + n иллюстраций', 'contract': 'v404.02-batch300-symbolic-0384'},
        'хозяйка купила 3 кг яблок, а груш — на 2 кг больше. сколько всего фруктов купила хозяйка?': {'answer_number': '8', 'answer_unit': 'кг', 'steps': ['3 + 2 = 5 (кг) – груш', '3 + 5 = 8 (кг) – фруктов'], 'final_answer': 'хозяйка купила 8 кг фруктов', 'contract': 'v404.02-batch300-exact-0385'},
        'в физкультурном зале 6 больших мячей, а маленьких — на 2 меньше. сколько всего мячей в физкультурном зале?': {'answer_number': '10', 'answer_unit': 'мячей', 'steps': ['6 - 2 = 4 (шт.) – маленьких мячей', '6 + 4 = 10 (шт.) – мячей'], 'final_answer': 'в физкультурном зале 10 мячей', 'contract': 'v404.02-batch300-exact-0386'},
        'у юли было 3 грецких ореха, земляных — на 2 больше, а арахиса столько, сколько земляных и грецких орехов вместе. сколько орехов арахиса у юли?': {'answer_number': '8', 'answer_unit': 'орехов', 'steps': ['3 + 2 = 5 (шт.) – земляных орехов', '3 + 5 = 8 (шт.) – орехов арахиса'], 'final_answer': 'у Юли 8 орехов арахиса', 'contract': 'v404.02-batch300-exact-0387'},
        'к празднику купили 2 красных шарика, а зеленых — на 4 шарика больше. сколько всего шариков купили к празднику?': {'answer_number': '8', 'answer_unit': 'шариков', 'steps': ['2 + 4 = 6 (шт.) – зеленых шариков', '2 + 6 = 8 (шт.) – шариков'], 'final_answer': 'к празднику купили 8 шариков', 'contract': 'v404.02-batch300-exact-0388'},
        'валя решила 7 примеров на сложение, а на вычитание — на 5 примеров меньше. сколько всего примеров решила валя?': {'answer_number': '9', 'answer_unit': 'примеров', 'steps': ['7 - 5 = 2 (шт.) – примеров', '7 + 2 = 9 (шт.) – примеров'], 'final_answer': 'Валя решила 9 примеров', 'contract': 'v404.02-batch300-exact-0389'},
        'в ателье приняли заказ на 5 платьев, костюмов — на 2 меньше, а курток столько, сколько платьев и костюмов вместе. сколько приняли заказов на пошив курток?': {'answer_number': '8', 'answer_unit': 'курток', 'steps': ['5 - 2 = 3 (шт.) – костюмов', '5 + 3 = 8 (шт.) – курток'], 'final_answer': 'приняли заказ на пошив 8 курток', 'contract': 'v404.02-batch300-exact-0390'},
        'в саду росло 4 гладиолуса, а лилий — на 1 больше. сколько всего цветов росло в саду?': {'answer_number': '9', 'answer_unit': 'цветов', 'steps': ['4 + 1 = 5 (шт.) – лилий', '4 + 5 = 9 (шт.) – цветов'], 'final_answer': 'в саду росло 9 цветов', 'contract': 'v404.02-batch300-exact-0391'},
        'на лугу паслось 2 быка, а коров — на 5 больше. сколько всего животных паслось на лугу?': {'answer_number': '9', 'answer_unit': 'животных', 'steps': ['2 + 5 = 7 (шт.) – коров', '2 + 7 = 9 (шт.) – животных'], 'final_answer': 'на лугу паслось 9 животных', 'contract': 'v404.02-batch300-exact-0392'},
        'в кафе было 5 молочников, а соусников — на 2 меньше. сколько всего соусников и молочников было в кафе?': {'answer_number': '8', 'answer_unit': 'соусников и молочников', 'steps': ['5 - 2 = 3 (шт.) – соусников', '5 + 3 = 8 (шт.) – соусников и молочников'], 'final_answer': 'в кафе было 8 соусников и молочников', 'contract': 'v404.02-batch300-exact-0393'},
        'на пристани стояло 3 катера, байдарок — на 2 больше, а лодок столько, сколько катеров и байдарок вместе. сколько всего лодок стояло на пристани?': {'answer_number': '8', 'answer_unit': 'лодок', 'steps': ['3 + 2 = 5 (шт.) – байдарок', '3 + 5 = 8 (шт.) – лодок'], 'final_answer': 'на пристани стояло 8 лодок', 'contract': 'v404.02-batch300-exact-0394'},
        'в ларек привезли 9 ящиков с виноградом, а с киви — на 8 меньше. сколько всего ящиков с фруктами привезли?': {'answer_number': '10', 'answer_unit': 'ящиков', 'steps': ['9 - 8 = 1 (шт.) – ящиков с киви', '9 + 1 = 10 (шт.) – ящиков с фруктами'], 'final_answer': 'в ларек привезли 10 ящиков с фруктами', 'contract': 'v404.02-batch300-exact-0395'},
        'в первом классе алиса посетила 2 города, во втором классе — на 3 города больше, а в пятом классе посетила столько городов, сколько в первом и во втором классе вместе. в скольких городах побывала алиса в пятом классе?': {'answer_number': '7', 'answer_unit': 'городах', 'steps': ['2 + 3 = 5 (шт.) – городов', '2 + 5 = 7 (шт.) – городов'], 'final_answer': 'Алиса в пятом классе побывала в 7 городах', 'contract': 'v404.02-batch300-exact-0396'},
        'с одного куста собрали 2 кг черноплодной рябины, а с другого на — 3 кг больше. сколько всего килограммов рябины собрали с двух кустов?': {'answer_number': '7', 'answer_unit': 'кг', 'steps': ['2 + 3 = 5 (кг) – рябины со второго куста', '2 + 5 = 7 (кг) – рябины'], 'final_answer': 'с двух кустов собрали 7 кг рябины', 'contract': 'v404.02-batch300-exact-0397'},
        'на даче было 7 грядок с морковкой, а с укропом — на 4 грядки меньше. сколько всего грядок с морковкой и укропом было на даче?': {'answer_number': '10', 'answer_unit': 'грядок', 'steps': ['7 - 4 = 3 (шт.) – грядок с укропом', '7 + 3 = 10 (шт.) – грядок'], 'final_answer': 'на даче было 10 грядок с морковкой и укропом', 'contract': 'v404.02-batch300-exact-0398'},
        'в саду росло 6 гвоздик, маков — на 2 меньше, а астр столько, сколько гвоздик и маков вместе. сколько астр росло в саду?': {'answer_number': '10', 'answer_unit': 'астр', 'steps': ['6 - 2 = 4 (шт.) – маков', '6 + 4 = 10 (шт.) – астр'], 'final_answer': 'в саду росло 10 астр', 'contract': 'v404.02-batch300-exact-0399'},
        'аня купила 1 кг фиников, а хурмы — на 3 кг больше. сколько всего фруктов купила аня?': {'answer_number': '5', 'answer_unit': 'кг', 'steps': ['1 + 3 = 4 (кг) – хурмы', '1 + 4 = 5 (кг) – фруктов'], 'final_answer': 'Аня купила 5 кг фруктов', 'contract': 'v404.02-batch300-exact-0400'},
    }
    spec = specs.get(key)
    return dict(spec) if isinstance(spec, dict) else None
...
def _v40111_apply_exact_user_requested_regression_solution(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # V404.02: frontend audit displays userVisibleResultText directly.
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V404.02: repair accepted-but-awkward answer orders from batch 100-199.
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    # V404.02: for assignment-style rows that are not solved by arithmetic,
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v404.02-live-excel-numeric-regression',
