...
APP_RELEASE = 'v311.02_live_g4_arithmetic_columnar_flow_audit_review'
SOLVER_VERSION = 'v311.02-live-g4-arithmetic-columnar-flow-audit-review'
...
def _v311_expression_solution_steps(expr: str, ans: int) -> list[str]:
    ...
    for left, right, op, result in operations:
        lines.append(f'{left} {op} {right} = {result}')
    chain = [pretty]
    current = pretty
    for left, right, op, result in operations:
