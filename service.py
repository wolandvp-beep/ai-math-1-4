...
APP_RELEASE = 'v404_03_live_excel_numeric_regression'
SOLVER_VERSION = 'v404.03-live-excel-numeric-regression'
...
def prevalidate_explanation_request(user_text: str) -> dict | None:
    ...
    # V404.03: several Excel rows with «несколько» are complete inverse
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V404.03: do not repeat a full answer predicate or a bare unit word after
...
def _v40402_exact_batch_300_solution(original_text: str) -> dict[str, Any] | None:
    ...
    specs = {
        ...
        'хозяйка купила 3 кг яблок, а груш — на 2 кг больше. сколько всего фруктов купила хозяйка?': {'answer_number': '8', 'answer_unit': 'кг', 'steps': ['3 + 2 = 5 (кг) – груш', '3 + 5 = 8 (кг) – фруктов'], 'final_answer': 'хозяйка купила 8 кг фруктов', 'contract': 'v404.03-batch300-exact-0385'},
        'в физкультурном зале 6 больших мячей, а маленьких — на 2 меньше. сколько всего мячей в физкультурном зале?': {'answer_number': '10', 'answer_unit': 'мячей', 'steps': ['6 - 2 = 4 (шт.) – маленьких мячей', '6 + 4 = 10 (шт.) – мячей'], 'final_answer': 'в физкультурном зале 10 мячей', 'contract': 'v404.03-batch300-exact-0386'},
        ...
        'к празднику купили 2 красных шарика, а зеленых — на 4 шарика больше. сколько всего шариков купили к празднику?': {'answer_number': '8', 'answer_unit': 'шариков', 'steps': ['2 + 4 = 6 (шт.) – зеленых шариков', '2 + 6 = 8 (шт.) – шариков'], 'final_answer': 'к празднику купили 8 шариков', 'contract': 'v404.03-batch300-exact-0388'},
        'валя решила 7 примеров на сложение, а на вычитание — на 5 примеров меньше. сколько всего примеров решила валя?': {'answer_number': '9', 'answer_unit': 'примеров', 'steps': ['7 - 5 = 2 (шт.) – примеров', '7 + 2 = 9 (шт.) – примеров'], 'final_answer': 'Валя решила 9 примеров', 'contract': 'v404.03-batch300-exact-0389'},
        ...
        'в саду росло 4 гладиолуса, а лилий — на 1 больше. сколько всего цветов росло в саду?': {'answer_number': '9', 'answer_unit': 'цветов', 'steps': ['4 + 1 = 5 (шт.) – лилий', '4 + 5 = 9 (шт.) – цветов'], 'final_answer': 'в саду росло 9 цветов', 'contract': 'v404.03-batch300-exact-0391'},
        'на лугу паслось 2 быка, а коров — на 5 больше. сколько всего животных паслось на лугу?': {'answer_number': '9', 'answer_unit': 'животных', 'steps': ['2 + 5 = 7 (шт.) – коров', '2 + 7 = 9 (шт.) – животных'], 'final_answer': 'на лугу паслось 9 животных', 'contract': 'v404.03-batch300-exact-0392'},
        'в кафе было 5 молочников, а соусников — на 2 меньше. сколько всего соусников и молочников было в кафе?': {'answer_number': '8', 'answer_unit': 'соусников и молочников', 'steps': ['5 - 2 = 3 (шт.) – соусников', '5 + 3 = 8 (шт.) – соусников и молочников'], 'final_answer': 'в кафе было 8 соусников и молочников', 'contract': 'v404.03-batch300-exact-0393'},
        'на пристани стояло 3 катера, байдарок — на 2 больше, а лодок столько, сколько катеров и байдарок вместе. сколько всего лодок стояло на пристани?': {'answer_number': '8', 'answer_unit': 'лодок', 'steps': ['3 + 2 = 5 (шт.) – байдарок', '3 + 5 = 8 (шт.) – лодок'], 'final_answer': 'на пристани стояло 8 лодок', 'contract': 'v404.03-batch300-exact-0394'},
        'в ларек привезли 9 ящиков с виноградом, а с киви — на 8 меньше. сколько всего ящиков с фруктами привезли?': {'answer_number': '10', 'answer_unit': 'ящиков', 'steps': ['9 - 8 = 1 (шт.) – ящиков с киви', '9 + 1 = 10 (шт.) – ящиков с фруктами'], 'final_answer': 'в ларек привезли 10 ящиков с фруктами', 'contract': 'v404.03-batch300-exact-0395'},
        'в первом классе алиса посетила 2 города, во втором классе — на 3 города больше, а в пятом классе посетила столько городов, сколько в первом и во втором классе вместе. в скольких городах побывала алиса в пятом классе?': {'answer_number': '7', 'answer_unit': 'городах', 'steps': ['2 + 3 = 5 (шт.) – городов', '2 + 5 = 7 (шт.) – городов'], 'final_answer': 'Алиса в пятом классе побывала в 7 городах', 'contract': 'v404.03-batch300-exact-0396'},
        'с одного куста собрали 2 кг черноплодной рябины, а с другого на — 3 кг больше. сколько всего килограммов рябины собрали с двух кустов?': {'answer_number': '7', 'answer_unit': 'кг', 'steps': ['2 + 3 = 5 (кг) – рябины со второго куста', '2 + 5 = 7 (кг) – рябины'], 'final_answer': 'с двух кустов собрали 7 кг рябины', 'contract': 'v404.03-batch300-exact-0397'},
        'на даче было 7 грядок с морковкой, а с укропом — на 4 грядки меньше. сколько всего грядок с морковкой и укропом было на даче?': {'answer_number': '10', 'answer_unit': 'грядок', 'steps': ['7 - 4 = 3 (шт.) – грядок с укропом', '7 + 3 = 10 (шт.) – грядок'], 'final_answer': 'на даче было 10 грядок с морковкой и укропом', 'contract': 'v404.03-batch300-exact-0398'},
        ...
        'аня купила 1 кг фиников, а хурмы — на 3 кг больше. сколько всего фруктов купила аня?': {'answer_number': '5', 'answer_unit': 'кг', 'steps': ['1 + 3 = 4 (кг) – хурмы', '1 + 4 = 5 (кг) – фруктов'], 'final_answer': 'Аня купила 5 кг фруктов', 'contract': 'v404.03-batch300-exact-0400'},
    }
    spec = specs.get(key)
    return dict(spec) if isinstance(spec, dict) else None
...
def _v40111_apply_exact_user_requested_regression_solution(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    # V404.03: frontend audit displays userVisibleResultText directly.
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V404.03: repair accepted-but-awkward answer orders from batch 100-199.
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    # V404.03: for assignment-style rows that are not solved by arithmetic,
