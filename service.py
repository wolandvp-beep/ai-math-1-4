...
APP_RELEASE = 'v402_06_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.06-live-excel-numeric-regression'
...
def _v40204_concise_counted_dash_explanation(original_text: str, explanation: str, unit_text: str = '') -> str:
    ...
    # V402.06: do not repeat a full answer predicate or a bare unit word after
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.06-green-lamps-concise-dash-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.06-beet-boxes-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.06-light-cars-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.06-freight-trains-full-answer',
        }
    return None
...
def _v4011_fix_answer_grammar(answer: str, original_text: str = '') -> str:
    ...
    # V402.06: repair accepted-but-awkward answer orders from batch 100-199.
