...
APP_RELEASE = 'v402_05_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.05-live-excel-numeric-regression'
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.05-green-lamps-concise-dash-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.05-beet-boxes-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.05-light-cars-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.05-freight-trains-full-answer',
        }
    return None
