...
APP_RELEASE = 'v413_02_live_excel_numeric_regression'
SOLVER_VERSION = 'v413.02-live-excel-numeric-regression'
...
def _v41302_batch_1201_1300_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    ...
    out['structuredSolution'] = dict(out.get('structured_solution') or {})
    contract = str(out.get('visibleResultContract') or '').strip()
    if 'v413.02-batch-1201-1300' not in contract:
        out['visibleResultContract'] = (contract + '; ' if contract else '') + 'v413.02-batch-1201-1300'
    out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v413.02-batch-1201-1300-exact-postprocess'
    return out
...
def _v40304_non_numeric_assignment_payload(payload: str) -> dict:
    ...
    return attach_release(_tag_payload({
        ...
        'visibleResultContract': 'v413.02-live-excel-numeric-regression',
