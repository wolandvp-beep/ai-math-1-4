...
APP_RELEASE = 'v402_03_live_excel_numeric_regression'
SOLVER_VERSION = 'v402.03-live-excel-numeric-regression'
...
def _v40111_exact_user_requested_regression_solution(original_text: str) -> dict[str, Any] | None:
    ...
    if (
        ...
        return {
            ...
            'contract': 'v402.03-baobab-thousand-years-numeric-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-student-remaining-tasks-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-currant-cups-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-girls-part-whole-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-linden-trees-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-voiceless-consonants-full-answer',
        }
    if (
        ...
        return {
            'answer_number': '3',
            'answer_unit': 'человек',
            'steps': ['10 - 7 = 3 (чел.) – человек заболело'],
            'final_answer': 'заболели 3 человека',
            'contract': 'v402.03-ill-people-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-arrived-cars-full-answer',
        }
    if (
        ...
        return {
            ...
            'contract': 'v402.03-birdhouses-remaining-full-answer',
        }
    return None
...
def _v40201_special_non_numeric_payload(payload: dict[str, Any] | None, original_text: str) -> dict[str, Any] | None:
    if _v40201_is_odd_mushroom_task(original_text):
        ...
        out['verifier'] = str(out.get('verifier') or '') + ('; ' if out.get('verifier') else '') + 'v402.03-special-non-numeric-repair'
        return out
    return None
