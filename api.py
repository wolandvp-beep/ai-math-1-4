...
def _next_live_audit_links(request: Request | None = None, key: str | None = None) -> dict:
    ...
    return {
        'nextAuditPlannedMapStep': 'v300 auto-latest re-audit: 1 класс, раздел 1 — Числа и величины',
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v300-auto-latest-dashboard-cache-v9'
...
def _live_audit_public_run_summary(run: dict[str, Any], *, include_failures_preview: bool = True) -> dict[str, Any]:
    ...
    out = {
        **_version_payload(),
        ...
        'nextPlannedMapStep': 'after v300 auto-latest pass: v301 — 1 класс, раздел 2 — Арифметические действия',
    }
...
async def live_audit_auto_current_release_guard(request: Request, expected_release: str, key_value: str):
    ...
    result['note'] = (
        'v300 auto-latest dashboard automation: open the fixed auto-latest endpoint, then click the release-guarded start/continue links; each step processes exactly one pending case and saves progress/cache. '
