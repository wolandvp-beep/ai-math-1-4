...
def _ui_render_audit_url(request: Request | None, key: str | None = None) -> str:
    ...
    query = urlencode([
        ...
        ('offset', '1000'),
        ('limit', '100'),
        ('cacheBust', 'v411-03-excel-numeric-regression'),
    ])
...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v411-03-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v411.03-live-excel-numeric-regression-v1'
...
def _api_v40305_nonnumeric_assignment_answer_only_payload(original_text: str, payload: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    out.update({
        ...
        'verifier': (prev_verifier + '; ' if prev_verifier else '') + 'v411.03-live-excel-numeric-regression',
    })
...
async def live_audit_browser_final_report(release_token: str, key_value: str, run_id_value: str):
    ...
    payload = {
        **dict(report),
        ...
        'finalReportFormat': 'compact-json-v411.03',
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v411-03-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
