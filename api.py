...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v311.05-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v311.05-g4-arithmetic-actions-v1'
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v311.05-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
