...
def _next_live_audit_links(request: Request | None = None, key: str | None = None) -> dict:
    ...
    auto_path = f'/api/diagnostics/live-audit/auto/{audit_key}/{release_token}'
    ...
    return {
        'nextAuditPlannedMapStep': 'v296 zero-copy re-audit: 1 класс, раздел 1 — Числа и величины',
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v295-clickable-dashboard-json-fix-v5'
...
def _live_audit_public_run_summary(run: dict[str, Any], *, include_failures_preview: bool = True) -> dict[str, Any]:
    ...
    out = {
        **_version_payload(),
        ...
        'nextPlannedMapStep': 'after v296 automation pass: v297 — 1 класс, раздел 2 — Арифметические действия',
    }
