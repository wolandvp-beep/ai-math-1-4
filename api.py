...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v302-live-audit'
...
LIVE_AUDIT_RUNNER_PROMPT_VERSION = 'v302-g2-text-problems-v1'
...
<meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate, max-age=0"><title>V302 frontend UI-render live-аудит</title>
<style>
...
<h1>V302 — frontend UI-render live-аудит</h1>
<section class="box">
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v302-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
...
async def live_audit_runner_report(key: str = '', runId: str = '', release: str = ''):
    ...
    return {
        **acceptance,
        ...
        'reportKind': 'V302 frontend UI-render proof audit for grade 2 text problems',
