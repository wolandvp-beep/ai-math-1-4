...
LIVE_PRODUCTION_AUDIT_DEFAULT_KEY = 'v297.06-live-audit'
...
async def live_production_audit_diagnostics(
    ...
    if not _live_audit_key_matches(key):
        return _json_error(403, {
            ...
            'hint': 'Default test key in this build: v297.06-live-audit. For production, set LIVE_AUDIT_KEY in Timeweb.',
        })
    try:
