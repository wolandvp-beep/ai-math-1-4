...
def _v305_g3_numbers_quantities_live_ui_cases() -> list[dict[str, Any]]:
    ...
    for idx, (a, b, area) in enumerate(rect_rows, 1):
        cases.append(make_case(f'v305_area_rect_{idx:02d}', 'v305_g3_area_rectangle', f'Найди площадь прямоугольника со сторонами {a} см и {b} см.', f'{area} кв. см', number=area, unit='кв. см'))
    sq_rows = [(7,49),(9,81),(12,144),(15,225)]
    for idx, (a, area) in enumerate(sq_rows, 1):
        cases.append(make_case(f'v305_area_square_{idx:02d}', 'v305_g3_area_square', f'Найди площадь квадрата со стороной {a} см.', f'{area} кв. см', number=area, unit='кв. см'))
...
def _v307_g3_text_problems_live_ui_cases() -> list[dict[str, Any]]:
    ...
    for idx, (a, b, c) in enumerate(add_rows, 1):
        ...
        cases.append(make_case(f'v307_two_step_add_{idx:02d}', 'v307_g3_two_step_addition', text, count(ans, 'книга'), number=ans, unit=plural(ans, *forms['книга'])))
    ...
    for idx, (a, b, c) in enumerate(sub_rows, 1):
        ...
        cases.append(make_case(f'v307_two_step_sub_{idx:02d}', 'v307_g3_two_step_subtraction', text, count(ans, 'коробка'), number=ans, unit=plural(ans, *forms['коробка'])))
    ...
    for idx, (boxes, per, used) in enumerate(group_rows, 1):
        ...
        cases.append(make_case(f'v307_equal_groups_{idx:02d}', 'v307_g3_equal_groups', text, count(ans, 'карандаш'), number=ans, unit=plural(ans, *forms['карандаш'])))
    ...
    for idx, (total, packs, extra) in enumerate(share_rows, 1):
        ...
        cases.append(make_case(f'v307_equal_sharing_{idx:02d}', 'v307_g3_equal_sharing', text, count(ans, 'тетрадь'), number=ans, unit=plural(ans, *forms['тетрадь'])))
    ...
    for idx, (qty, price, extra) in enumerate(price_rows, 1):
        ...
        cases.append(make_case(f'v307_price_total_{idx:02d}', 'v307_g3_price_quantity_cost', text, count(ans, 'руб.'), number=ans, unit='руб.'))
    ...
    for idx, (t1, v1, t2, v2) in enumerate(move_rows, 1):
        ...
        cases.append(make_case(f'v307_movement_two_speeds_{idx:02d}', 'v307_g3_movement', text, count(ans, 'км'), number=ans, unit='км'))
    ...
    for idx, (rate, t1, t2) in enumerate(prod_rows, 1):
        ...
        cases.append(make_case(f'v307_productivity_{idx:02d}', 'v307_g3_productivity', text, count(ans, 'деталь'), number=ans, unit=plural(ans, *forms['деталь'])))
    ...
    for idx, (qty, price, left) in enumerate(reverse_rows, 1):
        ...
        cases.append(make_case(f'v307_reverse_cost_{idx:02d}', 'v307_g3_reverse_problem', text, count(ans, 'руб.'), number=ans, unit='руб.'))
