...
def _v297_g1_text_problems_live_ui_cases() -> list[dict[str, Any]]:
    ...
    add_verbs = [
        'Ей дали ещё {delta} {item}.',
        'Мама купила ещё {delta} {item}.',
        'Друг подарил {delta} {item}.',
        'Ему принесли ещё {delta} {item}.',
        'К ним добавили ещё {delta} {item}.',
    ]
    for idx, (case_id, name, base_n, item, delta_n) in enumerate(add_data):
        verb = add_verbs[idx % len(add_verbs)].format(delta=delta_n, item=count(delta_n, item).split(' ', 1)[1])
        text = f'У {name} было {count(base_n, item)}. {verb} Сколько {forms[item][2]} стало у {name}?'
    ...
    sub_verbs = [
        'Он отдал другу {delta} {item}.',
        'Она подарила {delta} {item}.',
        'Убрали {delta} {item}.',
        'Взяли {delta} {item}.',
        'Забрали {delta} {item}.',
    ]
    for idx, (case_id, name, base_n, item, delta_n) in enumerate(sub_data):
        raw_verb = sub_verbs[idx % len(sub_verbs)].format(delta=delta_n, item=count(delta_n, item).split(' ', 1)[1])
        verb = raw_verb.replace('Он ', 'Он ' if name in {'пети', 'вани', 'саши', 'димы', 'ромы', 'дани', 'бори', 'максима', 'артема'} else 'Она ')
        verb = verb.replace('Она ', 'Она ' if name not in {'пети', 'вани', 'саши', 'димы', 'ромы', 'дани', 'бори', 'максима', 'артема'} else 'Он ')
    ...
    guard_cases = [
        ('v297_guard_incomplete_01', 'У лены было 7 тетрадей. Мама купила ещё несколько. Сколько тетрадей стало?', 'guard-low-confidence'),
        ('v297_guard_incomplete_02', 'У пети было несколько карандашей. Он отдал 2 карандаша. Сколько осталось?', 'guard-low-confidence'),
        ('v297_guard_incomplete_03', 'У оли было 5 яблок. Ей дали ещё несколько яблок. Сколько яблок стало?', 'guard-low-confidence'),
        ('v297_guard_incomplete_04', 'У иры было 9 книг. Подруга подарила ещё несколько книг. Сколько книг стало?', 'guard-low-confidence'),
        ('v297_guard_incomplete_05', 'У вани было 8 мячей. Он отдал несколько мячей. Сколько мячей осталось?', 'guard-low-confidence'),
        ...
        ('v297_guard_multi_01', 'У Маши было 5 яблок. Ей дали ещё 3 яблока. Сколько стало?\nУ Пети было 9 карандашей. Он отдал 4. Сколько осталось?', 'guard-multi-task'),
        ('v297_guard_multi_02', 'Вычисли 2 + 3.\nУ Маши было 5 яблок. Ей дали ещё 3 яблока. Сколько стало?', 'guard-multi-task'),
    ]
