...
def _v308_g3_geometry_live_ui_cases() -> list[dict[str, Any]]:
    ...
    for idx, (a, b) in enumerate(rect_area_rows, 1):
        ...
        cases.append(make_case(f'v308_rectangle_area_{idx:02d}', 'v308_g3_rectangle_area', text, f'площадь прямоугольника равна {area} кв. см', number=area, unit='кв. см'))
    ...
    for idx, side in enumerate(square_area_rows, 1):
        ...
        cases.append(make_case(f'v308_square_area_{idx:02d}', 'v308_g3_square_area', text, f'площадь квадрата равна {area} кв. см', number=area, unit='кв. см'))
    ...
    for idx, (a, b, c, d) in enumerate(composite_sum_rows, 1):
        ...
        cases.append(make_case(f'v308_composite_area_sum_{idx:02d}', 'v308_g3_composite_area_sum', text, f'площадь всей фигуры равна {total} кв. см', number=total, unit='кв. см'))
    ...
    for idx, (a, b, side) in enumerate(composite_diff_rows, 1):
        ...
        cases.append(make_case(f'v308_composite_area_difference_{idx:02d}', 'v308_g3_composite_area_difference', text, f'площадь оставшейся фигуры равна {remain} кв. см', number=remain, unit='кв. см'))
