...
def _excel_visible_step_unit_explanation_issues(case: dict[str, Any], result: str) -> list[str]:
    ...
    def expected_count_unit_kind() -> str:
        ...
        people = {
            ...
            'ребенок', 'ребенка', 'детей', 'дети', 'ученик', 'ученика', 'учеников', 'брат', 'брата', 'братьев', 'сестра', 'сестры', 'сестер', 'сестёр',
        }
        ...
        if unit in measurement:
            return ''
        # "10 тысяч глазков" is still a count of objects; (тыс. шт.) is acceptable.
