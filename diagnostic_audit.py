...
def _v307_g3_text_problems_live_ui_cases() -> list[dict[str, Any]]:
    ...
    for idx, (qty, price, extra) in enumerate(price_rows, 1):
        ...
        cases.append(make_case(f'v307_price_total_{idx:02d}', 'v307_g3_price_quantity_cost', text, f'заплатили {count(ans, "руб.")}', number=ans, unit='руб.'))
    ...
    for idx, (qty, price, left) in enumerate(reverse_rows, 1):
        ...
        cases.append(make_case(f'v307_reverse_cost_{idx:02d}', 'v307_g3_reverse_problem', text, f'у Димы было {count(ans, "руб.")}', number=ans, unit='руб.'))
